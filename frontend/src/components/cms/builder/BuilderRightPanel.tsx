        ...
        <aside className="lg:col-span-3 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 bg-[hsl(var(--bg-primary))] dark:bg-[hsl(var(--admin-bg-tertiary))] p-4 space-y-4 max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex border-b border-[hsl(var(--border))] dark:border-white/10 pb-2 gap-1 overflow-x-auto">
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1.5 rounded-md text-2xs font-semibold uppercase tracking-wide transition-all ${activeRightTab === "config" ? "bg-[hsl(var(--primary))] text-white" : "text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-2))] dark:hover:bg-white/5"}`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1.5 rounded-md text-2xs font-semibold uppercase tracking-wide transition-all ${activeRightTab === "seo" ? "bg-[hsl(var(--primary))] text-white" : "text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-2))] dark:hover:bg-white/5"}`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1.5 rounded-md text-2xs font-semibold uppercase tracking-wide transition-all ${activeRightTab === "ai" ? "bg-[hsl(var(--primary))] text-white" : "text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-2))] dark:hover:bg-white/5"}`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1.5 rounded-md text-2xs font-semibold uppercase tracking-wide transition-all ${activeRightTab === "analytics" ? "bg-[hsl(var(--primary))] text-white" : "text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-2))] dark:hover:bg-white/5"}`}
            >
          ...
          {activeRightTab === "config" && (
            <div className="space-y-4">
              <div className="space-y-2">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Estado página</p>
                <p className="text-sm font-bold">{activePage?.title || "Sin página"}</p>
                <p className="text-2xs uppercase tracking-wide text-[hsl(var(--text-secondary))]">{activePage?.status || "-"}</p>
                <input
                ...
                <div className="rounded-md border border-[hsl(var(--border))] dark:border-white/10 p-3 space-y-2">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">SEO Básico</p>
                  <input
                    value={seoTitleDraft}
                  ...
                  {seoImageDraft ? (
                    ...
                    <div className="rounded-md border border-dashed border-[hsl(var(--border))] dark:border-white/20 bg-[hsl(var(--surface-1))] dark:bg-white/5 p-3 text-center text-2xs font-bold uppercase tracking-wide text-[hsl(var(--text-secondary))]">
                      Sin imagen social
                    </div>
                  )}
                  <button
                    ...
                    disabled={!canEdit}
                    className="w-full rounded-lg bg-[hsl(var(--primary))] px-3 py-2 text-2xs font-semibold uppercase tracking-wide text-white inline-flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                ...
                <button
                  ...
                  className="w-full rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide disabled:opacity-50"
                >
                  Guardar pagina/SEO
                </button>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button onClick={() => runWorkflow("submit_review")} disabled={!activeSlug || !canEdit} className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50"><Send size={11} /> Review</button>
                  <button onClick={() => runWorkflow("approve")} disabled={!activeSlug || !canPublish} className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50"><Save size={11} /> Aprobar</button>
                  <button onClick={() => runWorkflow("publish")} disabled={!activeSlug || !canPublish} className="rounded-lg bg-primary text-white px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50"><Upload size={11} /> Publicar</button>
                  <button onClick={() => runWorkflow("revert_draft")} disabled={!activeSlug || !canEdit} className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50"><Undo2 size={11} /> Draft</button>
                  <button onClick={() => runWorkflow("archive")} disabled={!activeSlug || !canPublish} className="col-span-2 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50">Archivar</button>
                </div>
                <button
                  onClick={() => {
                  ...
                  disabled={!activeSlug}
                  className="w-full rounded-lg border border-[hsl(var(--info-muted))] text-[hsl(var(--info))] px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={!activeSlug}
                  className="w-full rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-1 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={!activePage || !canEdit}
                  className={`w-full rounded-lg border px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide disabled:opacity-50 ${activePage?.status === "archived" ? "border-[hsl(var(--success)/0.3)] text-[hsl(var(--success))]" : "border-[hsl(var(--warning)/0.3)] text-[hsl(var(--warning))]"}`}
                >
              ...
              <div className="space-y-2 pt-2 border-t border-[hsl(var(--border))] dark:border-white/10">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Versiones</p>
                <div className="max-h-40 overflow-auto space-y-2 pr-1">
                  {versions.map((version) => (
                    <button key={version.id} onClick={() => rollback(version.id)} disabled={!canPublish} className="w-full rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-2 text-left text-xs hover:border-primary/40 transition-all disabled:opacity-50 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                      ...
                      <p className="text-2xs text-[hsl(var(--text-secondary))]">{new Date(version.created_at).toLocaleString()}</p>
                    </button>
                  ))}
              ...
              <div className="space-y-2 pt-2 border-t border-[hsl(var(--border))] dark:border-white/10">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Historial de Cambios</p>
                <div className="max-h-40 overflow-auto space-y-2 pr-1">
                    ...
                    return (
                      <div key={entry.id} className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-2 text-xs bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                        <div className="flex items-center justify-between gap-2">
                          <p className="font-semibold uppercase tracking-wide text-2xs">{entry.action}</p>
                          <p className="text-2xs text-[hsl(var(--text-secondary))]">{new Date(entry.created_at).toLocaleTimeString()}</p>
                        </div>
                        <p className="mt-0.5 text-2xs text-[hsl(var(--text-secondary))]">{entry.from_status || "sin estado"} &rarr; {entry.to_status || "sin estado"}</p>
                        {notes && <p className="mt-1 text-2xs text-[hsl(var(--text-secondary))] line-clamp-2">{notes}</p>}
                      </div>
                    );
                  })}
          ...
          {activeRightTab === "seo" && (
            <div className="space-y-4 animate-fade-in">
              <div className="space-y-2 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Palabra Clave Objetivo</p>
                <input
                  value={seoKeyword}
                  ...
                  className="w-full rounded-lg border border-[hsl(var(--border))] dark:border-white/10 bg-transparent px-3 py-2 text-xs"
                />
                <p className="text-2xs text-[hsl(var(--text-secondary))]">Palabra clave principal para medir el SEO on-page.</p>
              </div>
              ...
              <div className="space-y-3 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-4 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                <div className="flex items-center justify-between">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Puntaje SEO</p>
                  <span className={`px-2 py-0.5 rounded-md text-2xs font-bold text-white ${seoAnalysis.score >= 80 ? "bg-[hsl(var(--success))]" : seoAnalysis.score >= 50 ? "bg-[hsl(var(--warning))]" : "bg-[hsl(var(--destructive))]"}`}>
                    {seoAnalysis.score}%
                  </span>
                </div>
                ...
                <p className="text-2xs text-[hsl(var(--text-secondary))] dark:text-[hsl(var(--text-secondary))]">
              ...
              {/* READABILITY SCORE */}
              <div className="space-y-2 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                <div className="flex items-center justify-between text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">
                ...
                <p className="text-2xs text-[hsl(var(--text-secondary))]">Medido utilizando la densidad silábica y longitud de oraciones de las secciones activas.</p>
              </div>
              ...
              <div className="space-y-3 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                <div className="flex items-center justify-between">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Simulador SERP Google</p>
                  <div className="inline-flex rounded border border-[hsl(var(--border))] dark:border-white/10 overflow-hidden">
                    <button
                      ...
                      className={`px-1.5 py-0.5 text-2xs font-bold uppercase transition-all ${serpPreviewDevice === "desktop" ? "bg-primary text-white" : "bg-transparent text-[hsl(var(--text-secondary))]"}`}
                    >
                      PC
                    </button>
                    <button
                      onClick={() => setSerpPreviewDevice("mobile")}
                      className={`px-1.5 py-0.5 text-2xs font-bold uppercase transition-all ${serpPreviewDevice === "mobile" ? "bg-primary text-white" : "bg-transparent text-[hsl(var(--text-secondary))]"}`}
                    >
                      Móvil
                    </button>
                  </div>
                  ...
                  {serpPreviewDevice === "mobile" ? (
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 text-xs text-[hsl(var(--text-secondary))]">
                        <span className="w-4 h-4 rounded-full bg-[hsl(var(--surface-3))] flex items-center justify-center text-2xs font-bold">⛪</span>
                    ...
                    <div className="space-y-1 text-left">
                      <div className="text-sm text-[hsl(var(--text-secondary))] leading-none">
                      ...
                      <div className="text-base text-[hsl(var(--text-secondary))] leading-relaxed line-clamp-2">
                        {seoDescriptionDraft || "Define una descripción para ver la vista previa social..."}
                      </div>
                    </div>
                  )}
              ...
              {/* ADVANCED SEO */}
              <div className="space-y-3 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">SEO Técnico</p>
                <div className="space-y-2">
                  <div>
                    <label className="text-2xs uppercase tracking-wide font-bold text-[hsl(var(--text-secondary))] block mb-1">Canonical URL</label>
                    <input
                      ...
                      className="w-full rounded-lg border border-[hsl(var(--border))] dark:border-white/10 bg-transparent px-3 py-2 text-xs"
                    />
                    <p className="text-2xs text-[hsl(var(--text-secondary))] mt-1">Si se deja vacío, se usa la URL automática de la página.</p>
                  </div>
                  <div>
                    <label className="text-2xs uppercase tracking-wide font-bold text-[hsl(var(--text-secondary))] block mb-1">Meta Robots</label>
                    <select
              ...
              <div className="space-y-2">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Recomendaciones SEO</p>
                  ...
                  {seoAnalysis.checks.map((check) => (
                    <div key={check.id} className="flex gap-2.5 items-start p-2 rounded-lg border border-[hsl(var(--border))] dark:border-white/5 bg-[hsl(var(--surface-1))]/30 dark:bg-white/[0.01]">
                      ...
                      <div>
                        ...
                        <p className="text-2xs text-[hsl(var(--text-secondary))] dark:text-[hsl(var(--text-secondary))] mt-0.5">{check.tip}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-4 animate-fade-in">
              <div className="space-y-2 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="text-2xs uppercase tracking-wide font-bold text-[hsl(var(--text-secondary))] block mb-1">Tono de Voz</label>
                    <select
                      value={aiTone}
                  ...
                  <div>
                    <label className="text-2xs uppercase tracking-wide font-bold text-[hsl(var(--text-secondary))] block mb-1">Temática / Contexto</label>
                    <textarea
                      value={aiPrompt}
                ...
                <button
                  ...
                  className="w-full mt-3 rounded-lg bg-[hsl(var(--primary))] px-3 py-2.5 text-2xs font-semibold uppercase tracking-wide text-white inline-flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {aiGenerating ? (
                    <>
              ...
              {aiOutput && (
                <div className="space-y-3 mt-3">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Resultado Generado</p>
                  <div className="p-3 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 bg-[hsl(var(--surface-2))] dark:bg-white/5 text-xs font-mono max-h-[180px] overflow-y-auto whitespace-pre-wrap animate-fade-in">
                    {aiOutput}
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      onClick={handleInsertAiAsSection}
                      className="rounded-lg bg-[hsl(var(--success))] text-white px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide hover:bg-[hsl(var(--success)/0.8)] transition-all inline-flex items-center justify-center gap-1"
                    >
                      Insertar final
                    </button>
                    <button
                      ...
                      className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1.5 text-2xs font-semibold uppercase tracking-wide hover:bg-[hsl(var(--surface-2))] dark:hover:bg-white/5 transition-all inline-flex items-center justify-center gap-1 disabled:opacity-40"
                    >
                      Reemplazar activa
                    </button>
                  </div>
              ...
              <div className="space-y-2 rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02] mt-3">
                <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Generador de Imágenes IA</p>
                <input
                  value={aiImagePrompt}
                ...
                <button
                  ...
                  className="w-full rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-3 py-2 text-2xs font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {aiImageGenerating ? (
                    <>
                  ...
                  <div className="space-y-2 mt-2 animate-fade-in">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        disabled={!activeSectionId}
                        className="rounded-lg bg-[hsl(var(--success))] text-white px-2 py-1 text-2xs font-semibold uppercase tracking-wide hover:bg-[hsl(var(--success)/0.8)] disabled:opacity-40"
                      >
                        Usar en Sección
                      </button>
                      <button
                        ...
                        className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 px-2 py-1 text-2xs font-semibold uppercase tracking-wide hover:bg-[hsl(var(--surface-2))] dark:hover:bg-white/5"
                      >
                        Usar en SEO
                      </button>
                    </div>
          ...
          {activeRightTab === "analytics" && (
            <div className="space-y-4 animate-fade-in">
              {/* TIMEFRAME SELECTOR */}
              <div className="flex border border-[hsl(var(--border))] dark:border-white/10 rounded-lg overflow-hidden text-2xs font-semibold uppercase tracking-wide">
                <button
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Visitas Totales</p>
                  <p className="text-lg font-bold text-[hsl(var(--text-primary))] dark:text-white mt-1">
                    {analytics?.total_views?.toLocaleString() ?? "—"}
                  </p>
                  <span className="text-2xs font-bold text-[hsl(var(--success))] inline-flex items-center gap-0.5 mt-1">
                    {analytics ? `${analytics.days}d` : "Sin datos"}
                  </span>
                </div>
                <div className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Visitas / Día</p>
                  <p className="text-lg font-bold text-[hsl(var(--text-primary))] dark:text-white mt-1">
                ...
                <div className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Pico Máximo</p>
                  <p className="text-lg font-bold text-[hsl(var(--text-primary))] dark:text-white mt-1">
                    {analytics?.daily_views?.length
                ...
                <div className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02]">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))]">Días con Actividad</p>
                  <p className="text-lg font-bold text-[hsl(var(--text-primary))] dark:text-white mt-1">
              ...
              <div className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02] space-y-3">
                <div className="flex items-center justify-between">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))] font-bold text-primary">Test A/B Integrado</p>
                  <button
                    onClick={() => setAbTestingActive(!abTestingActive)}
                    className={`px-2 py-0.5 rounded text-2xs font-bold uppercase transition-all ${abTestingActive ? "bg-[hsl(var(--success))] text-white animate-pulse" : "bg-[hsl(var(--surface-3))] dark:bg-white/10 text-[hsl(var(--text-secondary))] dark:text-[hsl(var(--text-secondary))]"}`}
                  >
                ...
                {abTestingActive ? (
                  <div className="space-y-2.5 animate-fade-in text-2xs">
                    ...
                    <div className="rounded border p-2 bg-[hsl(var(--surface-2))]/40 dark:bg-white/[0.01] space-y-1">
                      <p className="font-bold uppercase tracking-wider text-2xs text-[hsl(var(--text-secondary))]">Simulación de Conversión</p>
                      ...
                      <p className="text-2xs text-[hsl(var(--text-secondary))] mt-1">Confianza estadística: <strong className="text-[hsl(var(--success))] font-bold">97.4%</strong> (Resultado Significativo)</p>
                    </div>
                  </div>
                ) : (
                  <p className="text-2xs text-[hsl(var(--text-secondary))]">WordPress requiere plugins complejos para test A/B. Activa esta opción para diseñar variantes y dividir el tráfico automáticamente.</p>
                )}
              </div>
              ...
              <div className="rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 bg-[hsl(var(--surface-1))]/50 dark:bg-white/[0.02] space-y-3">
                <div className="flex items-center justify-between">
                  <p className="text-2xs font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))] font-bold">Mapa de Calor (Live)</p>
                  <button
                    onClick={() => setShowHeatmap(!showHeatmap)}
                    className={`px-3 py-1 rounded-md text-2xs font-semibold uppercase tracking-wide transition-all ${showHeatmap ? "bg-[hsl(var(--destructive))] text-white animate-pulse" : "bg-[hsl(var(--surface-3))] dark:bg-white/10 text-[hsl(var(--text-secondary))] dark:text-[hsl(var(--text-secondary))]"}`}
                  >
                ...
                {showHeatmap && (
                  <div className="space-y-2 animate-fade-in">
                    <label className="text-2xs uppercase tracking-wide font-bold text-[hsl(var(--text-secondary))] block mb-1">Tipo de Visualización</label>
                    <div className="flex rounded border border-[hsl(var(--border))] dark:border-white/10 overflow-hidden text-2xs font-bold text-center">
                      <button
