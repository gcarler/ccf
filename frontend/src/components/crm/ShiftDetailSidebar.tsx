            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-3 bg-slate-50 dark:bg-white/[0.03] rounded-xl border border-slate-100 dark:border-white/[0.05] shadow-sm">
                ...
                <div className="pt-4">
                    <button className="w-full py-2 bg-slate-900 dark:bg-blue-600 text-white rounded-xl text-[11px] font-bold uppercase tracking-wide shadow-2xl shadow-blue-500/25 flex items-center justify-center gap-3 group transition-all active:scale-95">
