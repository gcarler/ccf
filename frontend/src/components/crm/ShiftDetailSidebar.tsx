            ...
            <div className={clsx("p-4 shrink-0 relative overflow-hidden text-white rounded-t-lg border-b border-white/[0.04]", bgColor)}>
                ...
                <div className="flex justify-between items-start mb-3 relative z-10">
                    ...
                    <div className="flex gap-2">
                        <span className="px-4 py-1.5 bg-white/20 backdrop-blur-md rounded-lg text-2xs font-bold uppercase tracking-wide border border-white/10">
                            {shift.status}
                        </span>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-3 bg-[hsl(var(--surface-1))] dark:bg-white/[0.03] rounded-md border border-[hsl(var(--border))] dark:border-white/[0.05] shadow-sm">
                            ...
                            <p className="text-xs font-bold text-[hsl(var(--text-primary))] dark:text-[hsl(var(--text-secondary))] uppercase tracking-tight">{shift.time}</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="p-4 bg-[hsl(var(--bg-muted))] dark:bg-white/[0.03] rounded-md relative overflow-hidden group">
                        <div className="absolute inset-0 opacity-20 pointer-events-none bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] to-[hsl(var(--info)/20%)] via-transparent to-transparent group-hover:scale-110 transition-transform duration-1000" />
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2.5">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="flex items-center justify-between p-4 bg-[hsl(var(--bg-primary))] dark:bg-white/[0.02] border border-[hsl(var(--border))] dark:border-white/[0.05] rounded-md hover:bg-[hsl(var(--surface-1))] dark:hover:bg-white/[0.05] hover:border-[hsl(var(--info)/100%)]/20 transition-all group">
                                <div className="flex items-center gap-4">
                                    <div className="size-8 rounded-lg bg-gradient-to-tr from-[hsl(var(--surface-2))] to-[hsl(var(--surface-2))] dark:from-white/5 dark:to-white/10 flex items-center justify-center text-xs font-bold text-[hsl(var(--text-secondary))] shadow-sm group-hover:scale-110 transition-transform">
                                        V{i}
                                    </div>
                                    <div>
                ...
                <div className="pt-4">
                    <button className="w-full py-2 bg-[hsl(var(--bg-muted))] dark:bg-[hsl(var(--primary))] text-[hsl(var(--text-primary))] dark:text-white rounded-md text-xs font-bold uppercase tracking-wide shadow-2xl shadow-[hsl(var(--info)/25%)] flex items-center justify-center gap-3 group transition-all active:scale-95">
