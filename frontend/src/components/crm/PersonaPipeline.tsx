...
function SortablePersonaCard({ persona, onClick }: PersonaCardProps) {
    ...
    return (
        <div
            ...
            className="p-4 bg-[hsl(var(--bg-primary))] dark:bg-[hsl(var(--surface-2))] rounded-lg border border-[hsl(var(--border))] dark:border-white/5 shadow-sm hover:shadow-xl hover:border-[hsl(var(--info)/100%)]/30 transition-all cursor-grab active:cursor-grabbing group"
        >
            ...
            <div className="mt-4 pt-3 border-t border-[hsl(var(--border))] dark:border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-2xs font-bold text-[hsl(var(--text-secondary))]">2</span>
                </div>
                <div className="flex items-center gap-1.5 px-2 py-0.5 bg-success-soft dark:bg-[hsl(var(--success))]/20 text-success-text rounded-md text-2xs font-bold uppercase">
                    <Star size={10} /> VIP
                </div>
            </div>
        </div>
        ...
        <div className="min-w-[320px] w-[320px] flex flex-col shrink-0 gap-4">
            <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wide text-[hsl(var(--text-secondary))]">{title}</span>
                    <span className="text-2xs font-bold bg-[hsl(var(--surface-2))] dark:bg-white/5 px-2 py-0.5 rounded-full text-[hsl(var(--text-secondary))]">{personas.length}</span>
                </div>
