            ...
            <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                    <div className="size-14 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 dark:from-white/10 dark:to-white/5 flex items-center justify-center text-slate-400 group-hover:from-blue-600 group-hover:to-blue-700 group-hover:text-white transition-all shadow-sm">
                        <span className="text-base font-black">{(member.first_name?.[0] || '')}{(member.last_name?.[0] || '')}</span>
                    </div>
                    <div>
                            ...
                            >
                                <td className="px-4 py-2">
                                    <div className="flex items-center gap-3">
                                        <div className="size-8 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/40 dark:to-blue-800/20 text-blue-600 flex items-center justify-center font-black text-sm group-hover:scale-110 transition-transform">
    ...
    return (
        <div className="bg-white dark:bg-[#1e1f21] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden animate-fade-in shadow-sm">
            <div className="p-4 border-b border-slate-100 dark:border-white/5 flex items-center justify-between">
                <h3 className="text-sm font-black tracking-tight"><Calendar size={20} className="inline mr-2 text-slate-400" /> Calendario de Registros</h3>
            </div>
...
export function CrmGanttView({ members }: CrmViewProps) {
    ...
    return (
        <div className="bg-white dark:bg-[#1e1f21] shadow-sm rounded-xl border border-slate-200 dark:border-white/10 overflow-hidden animate-fade-in py-4 px-6">
            <h3 className="text-sm font-black tracking-tight mb-8">Timeline de Integración (Últimos 15)</h3>
