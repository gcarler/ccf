...
export default function CertificateView({ data }: CertificateProps) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="relative aspect-[1.414/1] w-full bg-white dark:bg-slate-900 border-[16px] border-slate-900 dark:border-blue-900/20 shadow-2xl p-12 flex flex-col items-center justify-between text-center overflow-hidden group">
                ...
                <div className="relative z-10 space-y-4">
                    <div className="size-20 bg-slate-900 dark:bg-blue-600 rounded-2xl mx-auto flex items-center justify-center text-white shadow-xl">
                        <Award size={40} />
                    </div>
                    <h1 className="text-sm font-black uppercase tracking-[0.4em] text-slate-400">Certificado de Logro Académico</h1>
                </div>
                ...
                <div className="relative z-10 space-y-8 py-8">
                    <div>
                        ...
                        <h2 className="text-4xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tight mt-2 uppercase">
                            {data.enrollment.student.username}
                        </h2>
                    </div>

                    <div className="max-w-lg mx-auto">
                        <p className="text-slate-500 dark:text-slate-400 font-medium">Ha completado satisfactoriamente los requisitos académicos para el curso de:</p>
                ...
                <div className="relative z-10 w-full flex justify-between items-end border-t border-slate-100 dark:border-white/5 pt-8">
                    ...
                    <div className="text-right space-y-1">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Firma Autorizada</p>
                        <p className="text-sm font-bold text-slate-700 dark:text-slate-200 font-serif italic">Dirección Académica CCF</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-4">
                <button className="px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-2 shadow-xl active:scale-95 transition-all">
                    <Download size={18} /> Descargar PDF
                </button>
                <button className="px-8 py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-slate-50 transition-all active:scale-95">
