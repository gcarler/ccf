                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {milestones.map((m) => (
                        <div key={m.id} className="bg-[hsl(var(--bg-primary))] dark:bg-white/5 border border-[hsl(var(--border))] dark:border-white/5 rounded-lg p-3 hover:shadow-2xl transition-all group relative overflow-hidden">
                            ...
                            <h4 className="text-base font-bold text-[hsl(var(--text-primary))] dark:text-white mb-1 leading-tight">{m.title}</h4>
                            <p className="text-xs text-[hsl(var(--text-secondary))] dark:text-[hsl(var(--text-secondary))] font-medium leading-relaxed">{m.description}</p>
                        </div>
                    ))}
                </div>
            </section>
