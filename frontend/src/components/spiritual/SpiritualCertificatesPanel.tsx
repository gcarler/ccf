    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center h-40 gap-3">
                ...
                <p className="text-[9px] font-semibold uppercase tracking-wide text-slate-400">Consultando registros...</p>
            </div>
        );
    }
        ...
        <div className="space-y-6 p-3">
            {certificates.length === 0 ? (
                <div className="text-center py-1.5 bg-slate-50 dark:bg-white/[0.02] rounded-lg border border-dashed border-slate-200 dark:border-white/10">
                    ...
                    <p className="font-semibold text-slate-400 uppercase tracking-wide">Sembrando esfuerzo para cosechar victoria</p>
                </div>
            ) : (
                            ...
                            >
                                ...
                                <div className="pt-5 border-t border-slate-100 dark:border-white/[0.04] flex items-center justify-between relative z-10">
                                    <div className="space-y-0.5">
                                        <p className="font-semibold text-slate-400 uppercase tracking-wide opacity-60">ID DE VALIDACIÓN</p>
