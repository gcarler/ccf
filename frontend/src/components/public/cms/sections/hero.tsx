...
export function VideoHeroSection({ section }: { section: CmsSection<"video_hero"> }) {
  ...
  return (
    <section className={`relative overflow-hidden ${fullBleed ? "left-1/2 w-screen -translate-x-1/2 rounded-none" : "rounded-2xl"} min-h-[clamp(420px,72vh,760px)] flex items-center`}>
      {videoUrl && (
