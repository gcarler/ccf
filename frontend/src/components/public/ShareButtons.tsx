...
export default function ShareButtons({ title, className = '' }: ShareButtonsProps) {
    ...
    const getText = () => title || (typeof document !== 'undefined' ? document.title : 'Comunidad Cristiana El Faro');

    const shareOn = (network: 'facebook' | 'twitter' | 'whatsapp') => {
        ...
        window.open(links[network], '_blank', 'noopener,noreferrer,width=600,height=400');
    };
