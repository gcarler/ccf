...
export default function FaroMobileNav() {
    return (
        <div className="md:hidden fixed bottom-0 left-0 w-full flex justify-center pb-8 z-50">
            <div className="bg-[#001134]/80 backdrop-blur-2xl w-[90%] max-w-md rounded-[0.75rem] px-6 py-3 flex justify-between items-center shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
