...
export default function ForumThreadDetail() {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50/50 dark:bg-[#1e1f21] overflow-hidden font-display">
            <WorkspaceToolbar
                ...
                rightActions={
                    <button onClick={() => router.back()} className="flex items-center gap-2 px-4 py-2 text-slate-400 hover:text-[hsl(var(--primary))] transition-all text-[11px] font-semibold uppercase tracking-wide">
 ...
 <div className="w-full grid gap-3 md:grid-cols-2">
                        {replies.map((reply) => (
                            <article key={reply.id} className="rounded-md border border-slate-200 bg-[hsl(var(--bg-primary))] p-4 dark:border-white/10 dark:bg-white/5">
                    ...
                    <section className="bg-[hsl(var(--bg-primary))] dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg p-3 shadow-xl space-y-3 relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col gap-4">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2 bg-[hsl(var(--bg-primary))] dark:bg-white/5 p-1 rounded-lg border border-slate-200 dark:border-white/10">
                                    <button className="flex items-center gap-2 px-4 py-2 hover:bg-slate-50 dark:hover:bg-white/5 rounded-md font-semibold text-[hsl(var(--primary))] transition-all">
                                    ...
                                    <div className="flex gap-4 items-start">
                                        ...
                                        <div className="flex-1 space-y-4">
                                            ...
                                            <div className="flex items-center gap-4 pt-4">
                                                <button className="flex items-center gap-1.5 font-semibold text-slate-400 hover:text-[hsl(var(--primary))] transition-colors uppercase"><ThumbsUp size={14} /> {reply.upvotes}</button>
                                                <button className="font-semibold text-slate-400 hover:text-[hsl(var(--primary))] transition-colors uppercase">Responder</button>
                                            </div>
                                        </div>
                                    </div>
                                </motion.div>
