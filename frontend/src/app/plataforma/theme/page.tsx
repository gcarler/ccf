            ...
            <header className="sticky top-0 z-20 border-b border-[hsl(var(--border))]/60 bg-white/80 backdrop-blur-xl dark:border-white/5 dark:bg-[#0f1117]/80">
                <div className="mx-auto flex max-w-4xl items-center justify-between px-3 py-1.5">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-base font-bold uppercase tracking-wide text-[hsl(var(--text-primary))] dark:text-[hsl(var(--text-secondary))]">Tema visual</h1>
                    </div>
                    <Link
                        href="/plataforma/settings"
                        className="inline-flex items-center gap-2 rounded-lg border border-[hsl(var(--border))] px-4 py-2 text-2xs font-bold uppercase tracking-wide text-[hsl(var(--text-secondary))] transition hover:border-[hsl(var(--border))] hover:bg-[hsl(var(--surface-1))] dark:border-white/10 dark:text-[hsl(var(--text-secondary))]"
                    >
            ...
            <main className="mx-auto max-w-4xl space-y-3 px-3 py-1.5">
                <section className="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--bg-primary))] p-4 shadow-sm dark:border-white/5 dark:bg-[#1a1d27]">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <span className="inline-flex items-center gap-2 rounded-full bg-info-soft px-3 py-1 text-2xs font-bold uppercase tracking-wide text-[hsl(var(--primary))] dark:bg-[hsl(var(--info))]/10 dark:text-info-text">
