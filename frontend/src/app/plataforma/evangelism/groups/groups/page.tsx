...
function GroupsContent() {
  ...
  return (
    <>
      ...
      >
        <div className="flex h-full p-4 lg:p-4 bg-[hsl(var(--bg-muted))]/50 dark:bg-[hsl(var(--surface-card)/0.5)]">
          {/* Detail/Edit Panel */}
          {showPanel ? (
            <ErrorBoundary moduleName="Grupos - Detalle" compact>
              <div className="flex-1 bg-[hsl(var(--bg-primary))] dark:bg-[hsl(var(--surface-card))] rounded-lg border border-[hsl(var(--border-primary))] shadow-sm flex flex-col overflow-hidden animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                {selectedHouse || isCreating ? (
                  ...
                  <div className="flex-1 overflow-y-auto bg-[hsl(var(--bg-primary))] dark:bg-[hsl(var(--surface-card))]">
