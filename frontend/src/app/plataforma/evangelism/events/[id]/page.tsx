...
function PersonaSelect({ personas, value, onChange, label, multi = false }: PersonaSelectProps) {
 ...
 className="w-full pl-9 pr-4 py-1.5 bg-[hsl(var(--bg-muted))] dark:bg-black/20 border border-[hsl(var(--border-primary))] rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500"
 />
 </div>
 {open && search && (
...
export default function EventDetailPage() {
 ...
 <div key={`${att.persona_id}-${att.role}`} className="flex items-center justify-between gap-3 rounded-md bg-[hsl(var(--bg-primary))] dark:bg-[#1e1f21] border border-[hsl(var(--border-primary))] px-3 py-2">
 ...
 actions={
 <>
 <button type="button" disabled={savingVisitor} onClick={() => setIsVisitorModalOpen(false)} className="px-4 py-2 text-[11px] font-bold text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] transition-colors disabled:opacity-60">
 Cancelar
 </button>
 ...
 <input required disabled={savingVisitor} value={visitorForm.first_name} onChange={e => setVisitorForm({...visitorForm, first_name: e.target.value})} className="w-full px-4 py-1.5 bg-[hsl(var(--bg-muted))] dark:bg-black/20 border border-[hsl(var(--border-primary))] rounded-md text-sm font-bold outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60" placeholder="Juan" />
 </div>
 <div className="space-y-1.5">
 <label className="text-[10px] font-semibold uppercase tracking-wide text-[hsl(var(--text-secondary))] block">Apellido</label>
 <input required value={visitorForm.last_name} onChange={e => setVisitorForm({...visitorForm, last_name: e.target.value})} className="w-full px-4 py-1.5 bg-[hsl(var(--bg-muted))] dark:bg-black/20 border border-[hsl(var(--border-primary))] rounded-md text-sm font-bold outline-none focus:ring-2 focus:ring-blue-500" placeholder="Pérez" />
 </div>
 </div>
 <div className="space-y-1.5">
 ...
 <input disabled={savingVisitor} value={visitorForm.phone} onChange={e => setVisitorForm({...visitorForm, phone: e.target.value})} className="w-full px-4 py-1.5 bg-[hsl(var(--bg-muted))] dark:bg-black/20 border border-[hsl(var(--border-primary))] rounded-md text-sm font-bold outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60" placeholder="+57 300 000 0000" />
 </div>
 <div className="space-y-1.5">
 ...
 <input type="email" disabled={savingVisitor} value={visitorForm.email} onChange={e => setVisitorForm({...visitorForm, email: e.target.value})} className="w-full px-4 py-1.5 bg-[hsl(var(--bg-muted))] dark:bg-black/20 border border-[hsl(var(--border-primary))] rounded-md text-sm font-bold outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60" placeholder="correo@ejemplo.com" />
 </div>
 </div>
 </WorkspaceDrawer>
