...
export default function FinanceAdminPage() {
            ...
            cell: ({ row }) => (
                <div className="flex items-center gap-3 truncate">
                    ...
                    <div className="flex flex-col truncate">
                        ...
                        <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wide leading-none mt-0.5">{row.original.category}</span>
                    </div>
                </div>
            )
        },
    ...
    return (
        <div className="flex flex-col h-full bg-[hsl(var(--bg-primary))] dark:bg-[#1e1f21] overflow-hidden animate-fade-in font-display">
            ...
            <div className="flex px-3 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/5 shrink-0 overflow-x-auto no-scrollbar">
                        ...
                        {loading ? (
                            ...
                            <motion.div key="board" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex gap-4 overflow-x-auto">
                                {groupedTransactions.map((column) => (
                                    <section key={column.type} className="w-96 shrink-0 rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-white/10 dark:bg-white/[0.03]">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
                                    ...
                                    <div className="lg:col-span-8 p-4 bg-slate-900 rounded-lg text-white shadow-2xl relative overflow-hidden group border border-white/5 animate-in fade-in slide-in-from-bottom-4 duration-700">
                                        ...
                                        <div className="space-y-3 relative z-10">
                                            ...
                                            <div className="flex justify-between px-2 font-semibold text-slate-500 uppercase tracking-wide">
