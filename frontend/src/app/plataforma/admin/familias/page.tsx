                                        ...
                                        <motion.tr key={fam.id}
                                            ...
                                            <td className="py-3 px-4">
                                                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <button onClick={() => openEdit(fam)} className="p-2 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-md text-slate-400 hover:text-[hsl(var(--primary))] transition-all"><Pencil size={14} /></button>
                                                    {deleteId === fam.id ? (
