            ...
            <div className="flex flex-col h-full bg-[hsl(var(--bg-primary))] rounded-lg overflow-hidden border border-[hsl(var(--success)/30%)] shadow-2xl relative font-mono">
                ...
                <div className="p-4 border-b border-[hsl(var(--success)/50%)] bg-black/40 flex justify-between items-center relative z-10 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-[hsl(var(--success))] uppercase tracking-wide flex items-center gap-3">
                                Control de Acceso Maestro
                                <span className="flex size-3 relative">
                                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[hsl(var(--danger))] opacity-75"></span>
