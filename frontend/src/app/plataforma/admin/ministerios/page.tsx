                        ...
                        {filtered.map((m, idx) => (
                            <motion.div key={m.id}
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button onClick={() => openEdit(m)} className="p-2 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-md text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--primary))] transition-all"><Pencil size={14} /></button>
                                        <button onClick={() => setDeleteId(m.id)} className="p-2 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-md text-[hsl(var(--text-secondary))] hover:text-rose-600 transition-all"><Trash2 size={14} /></button>
                                    </div>
                                </div>
