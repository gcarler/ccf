              ...
              filtered.map((doc) => {
                ...
                return (
                  <motion.div key={doc.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-[hsl(var(--bg-primary))] dark:bg-[#111418] rounded-lg border border-[hsl(var(--border))] dark:border-white/10 p-3 shadow-sm hover:shadow-lg hover:border-blue-500/20 transition-all group">
                    ...
                    {doc.ai_summary && (                        <div className="mb-2 p-1.5 rounded-md bg-blue-50 dark:bg-blue-900/10 text-[10px] text-blue-700 dark:text-blue-300">
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {doc.ai_tags?.map((tag: string, idx: number) => (
                        <span key={idx} className="px-1.5 py-0.5 rounded-full text-[9px] font-bold bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-300">{tag}</span>
                      ))}
                    </div>
