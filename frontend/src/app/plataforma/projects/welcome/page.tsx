    ...
    return (
        <div className="flex flex-col h-full bg-[hsl(var(--bg-primary))] dark:bg-[#1e1f21] overflow-hidden animate-fade-in font-display">
            ...
            <main className="flex-1 overflow-y-auto p-3">
                {viewType === 'list' && (
                    <div className="max-w-3xl space-y-3">
                        {quickStarts.map((item) => (
                            <article key={item.title} className="rounded-lg border border-slate-200 bg-[hsl(var(--bg-primary))] p-3 dark:border-white/10 dark:bg-white/5">
                ...
                {viewType === 'table' && (
                    <div className="max-w-4xl overflow-hidden rounded-lg border border-slate-200 bg-[hsl(var(--bg-primary))] dark:border-white/10 dark:bg-white/5">
