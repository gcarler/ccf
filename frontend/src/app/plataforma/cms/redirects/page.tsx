          ...
          <tbody className="divide-y">
            {loading ? (
              ...
              <tr key={r.id} className="hover:bg-[hsl(var(--surface-1))]/50">
                ...
                <td className="px-4 py-3"><span className={`text-2xs font-bold px-2 py-0.5 rounded-full ${r.status_code === 301 ? "bg-green-100 text-[hsl(var(--secondary))]" : "bg-[hsl(var(--warning-muted))] text-warning-text"}`}>{r.status_code}</span></td>
