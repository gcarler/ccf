      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[hsl(var(--text-secondary))]">{sessions.length} sesiones activas</p>
          </div>
        </div>
        {sessions.length > 1 && (
          ...
          return (
            <div key={s.id} className="flex items-center gap-4 p-4 border rounded-xl bg-[hsl(var(--bg-primary))]">
              <div className="w-10 h-10 rounded-lg bg-[hsl(var(--surface-2))] flex items-center justify-center">
                {s.is_mobile ? <Smartphone size={18} className="text-[hsl(var(--text-secondary))]" /> : <Monitor size={18} className="text-[hsl(var(--text-secondary))]" />}
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium">{ua.browser} en {ua.os}</p>
                <p className="text-xs text-[hsl(var(--text-secondary))]">IP: {s.ip_address || "N/A"}</p>
              </div>
