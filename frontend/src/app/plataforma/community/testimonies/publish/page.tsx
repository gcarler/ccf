            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <section className="space-y-3">
                    ...
                    <div className="relative group">
                        <div className="absolute -inset-1 bg-gradient-to-br from-[hsl(var(--primary))] to-transparent opacity-0 group-focus-within:opacity-10 transition-opacity rounded-md blur-xl"></div>
