                        ...
                        <>
                            ...
                            <section className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                ...
                                <Link
                                    ...
                                    className="group relative overflow-hidden rounded-lg border-2 border-dashed border-[hsl(var(--border))] dark:border-white/10 p-5 hover:border-emerald-400/40 dark:hover:border-emerald-400/40 transition-all bg-[hsl(var(--bg-primary))] dark:bg-white/5 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/10 no-underline"
                                >
                                    <div className="flex items-center gap-3">
                                    ...
                                    <ArrowUpRight className="absolute top-3 right-3 size-4 text-[hsl(var(--text-secondary))] group-hover:text-emerald-500 transition-colors" />
                                </Link>

                                <Link
                                    href="/plataforma/crm/counseling"
                                    className="group relative overflow-hidden rounded-lg border-2 border-dashed border-[hsl(var(--border))] dark:border-white/10 p-5 hover:border-blue-400/40 dark:hover:border-blue-400/40 transition-all bg-[hsl(var(--bg-primary))] dark:bg-white/5 hover:bg-blue-50/50 dark:hover:bg-blue-900/10 no-underline"
                                >
                                    <div className="flex items-center gap-3">
