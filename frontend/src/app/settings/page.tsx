        ...
        <div className="min-h-full bg-slate-50 dark:bg-[#0f1117]">
            ...
            <div className="sticky top-0 z-30 bg-white/80 dark:bg-[#0f1117]/80 backdrop-blur-xl border-b border-slate-200/60 dark:border-white/5">
                <div className="max-w-3xl mx-auto px-6 py-4 flex items-center gap-3">
                    ...
                    <h1 className="text-[13px] font-black uppercase tracking-widest text-slate-700 dark:text-slate-200">
                        Configuración
                    </h1>
                </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto px-6 py-8 space-y-8">
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-[#1a1d27] rounded-2xl border border-slate-200/60 dark:border-white/5 p-6 flex items-center gap-5 shadow-sm"
                >
                    <div className="size-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-xl font-black shadow-lg shadow-blue-500/20 shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <span className="mt-1 inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-[9px] font-black uppercase tracking-widest">
                            <Shield size={9} /> Admin
                        </span>
                    </div>
                    <button
                        onClick={() => router.push('/account')}
                        className="px-4 py-2 text-[11px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-400 hover:text-blue-600 border border-slate-200 dark:border-white/10 rounded-xl hover:border-blue-500/50 transition-all"
                    >
                        Editar
                    </button>
                </motion.div>
                ...
                >
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-4">Tema Visual</p>
                    <div className="grid grid-cols-3 gap-3">
                        {([
                            ...
                            <button
                                ...
                                className={clsx(
                                    "flex flex-col items-center gap-2 py-4 rounded-xl border-2 transition-all text-[11px] font-black uppercase tracking-widest",
                                    theme === t.id
                        ...
                        <div className="bg-white dark:bg-[#1a1d27] rounded-2xl border border-slate-200/60 dark:border-white/5 shadow-sm divide-y divide-slate-100 dark:divide-white/5 overflow-hidden">
                            {group.items.map((item, ii) => (
                                <button
                                    ...
                                    className="w-full flex items-center gap-4 px-5 py-4 hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-all group text-left"
                                >
                                    <div className={clsx("size-9 rounded-xl flex items-center justify-center shrink-0", COLOR_MAP[group.color])}>
                                        <item.icon size={16} />
                                    </div>
                                    <div className="flex-1 min-w-0">
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-[#1a1d27] rounded-2xl border border-rose-100 dark:border-rose-500/10 p-5 shadow-sm space-y-3"
                >
                    <p className="text-[10px] font-black uppercase tracking-widest text-rose-400 mb-4">Zona de Peligro</p>
                    <button
                        onClick={() => { logout(); router.push('/login'); }}
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-all text-[12px] font-bold"
                    >
                        <LogOut size={16} /> Cerrar Sesión
                    </button>
                    <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-all text-[12px] font-bold">
                        <Trash2 size={16} /> Eliminar mi cuenta
                    </button>
                </motion.div>

                <p className="text-center text-[10px] text-slate-300 dark:text-slate-700 font-bold uppercase tracking-widest pb-8">
