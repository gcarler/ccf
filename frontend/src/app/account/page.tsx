        ...
        <div className="flex flex-col h-full bg-white dark:bg-[#1e1f21] overflow-hidden animate-fade-in font-display">
            <WorkspaceToolbar 
                ...
                rightActions={
                    <button 
                        ...
                        className="flex items-center gap-2 px-6 py-2 bg-blue-600 text-white rounded-xl text-[11px] font-black uppercase tracking-widest shadow-xl shadow-blue-500/20 active:scale-95 transition-all disabled:opacity-50"
                    >
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <aside className="w-72 lg:w-80 border-r border-slate-100 dark:border-white/5 bg-slate-50/30 dark:bg-black/10 p-6 space-y-1 shrink-0 relative z-10">
                    <div className="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-6 mt-2">
                    ...
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={clsx(
                                "w-full flex items-center gap-4 px-5 py-4 rounded-2xl text-[13px] font-black transition-all group relative overflow-hidden",
                                activeTab === tab.id 
                    ...
                    <div className="pt-10 mt-10 border-t border-slate-100 dark:border-white/5">
                        <button onClick={logout} className="w-full flex items-center gap-4 px-5 py-4 rounded-2xl text-[13px] font-black text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-all group">
                ...
                {/* Content Area 3.0 */}
                <main className="flex-1 overflow-y-auto scrollbar-thin p-8 lg:p-16 bg-white dark:bg-[#1e1f21] relative">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10">
                        <AnimatePresence mode="wait">
                            {activeTab === 'profile' && (
                                ...
                                >
                                    {/* Profile Hero Card */}
                                    <section className="flex flex-col md:flex-row items-center gap-10 p-10 bg-slate-50 dark:bg-black/20 rounded-[3rem] border border-slate-100 dark:border-white/5 shadow-sm group">
                                        <div className="relative group cursor-pointer">
                                            <div className="size-32 rounded-[2.5rem] bg-white dark:bg-white/5 border-2 border-slate-200 dark:border-white/10 flex items-center justify-center overflow-hidden transition-all group-hover:border-blue-500 group-hover:shadow-2xl group-hover:scale-105 duration-500">
                                            ...
                                            <div className="absolute -bottom-2 -right-2 size-10 bg-blue-600 text-white rounded-2xl flex items-center justify-center shadow-2xl border-4 border-white dark:border-[#1e1f21] group-hover:scale-110 transition-transform">
                                                <Camera size={18} />
                                            </div>
                                        </div>
                                        <div className="space-y-2 text-center md:text-left flex-1 min-w-0">
                                            <h3 className="text-3xl font-black text-slate-800 dark:text-white tracking-tighter">Tu Perfil Público</h3>
                                            ...
                                            <div className="flex flex-wrap justify-center md:justify-start gap-2 pt-4">
                                                <div className="px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg text-[10px] font-black uppercase tracking-widest border border-blue-100 dark:border-blue-900/50 flex items-center gap-2"><ShieldCheck size={12} /> {user?.role || 'Miembro'}</div>
                                                <div className="px-3 py-1 bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 rounded-lg text-[10px] font-black uppercase tracking-widest border border-slate-200 dark:border-white/10 flex items-center gap-2"><Globe size={12} /> Sede Central</div>
                                            </div>
                                        </div>
                                    </section>

                                    <section className="space-y-8">
                                        <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] px-4">Información Personal</h4>
                                    ...
                                    <section className="p-10 bg-gradient-to-br from-slate-900 to-[#1e1f21] rounded-[3rem] border border-white/5 text-white flex items-center justify-between shadow-2xl relative overflow-hidden group">
                                        <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600/10 rounded-full blur-[100px] group-hover:scale-110 transition-transform duration-1000" />
                                        <div className="relative z-10 flex items-center gap-6">
                                            <div className="size-16 rounded-[1.5rem] bg-white/10 border border-white/20 flex items-center justify-center text-blue-400 shadow-xl group-hover:rotate-12 transition-transform duration-500"><Smartphone size={32} /></div>
                                            <div>
                                                <h4 className="text-xl font-black tracking-tight">Seguridad Móvil</h4>
                                                <p className="text-slate-400 text-sm font-medium">Verifica tu número para habilitar alertas pastorales por WhatsApp.</p>
                                            </div>
                                        </div>
                                        <button className="relative z-10 px-8 py-4 bg-white text-slate-900 rounded-[1.5rem] font-black text-[11px] uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl">Verificar Ahora</button>
                                    </section>
                                </motion.div>
                            )}
                            ...
                            {activeTab === 'security' && (
                                ...
                                >
                                    <div className="p-10 bg-white dark:bg-white/5 rounded-[3rem] border border-slate-100 dark:border-white/5 shadow-sm space-y-10">
                                        <div className="flex items-center gap-4">
                                            <div className="size-12 rounded-2xl bg-rose-50 dark:bg-rose-900/30 text-rose-500 flex items-center justify-center shadow-inner"><Lock size={24} /></div>
                                            <h3 className="text-2xl font-black tracking-tighter">Cambiar Contraseña</h3>
                                        </div>
                                    ...
                                    <div className="p-10 bg-blue-50/50 dark:bg-blue-500/5 rounded-[3rem] border border-blue-100 dark:border-blue-500/20 flex flex-col md:flex-row items-center justify-between gap-8 group">
                                        <div className="flex items-center gap-6">
                                            <div className="size-16 rounded-[1.5rem] bg-white dark:bg-white/10 flex items-center justify-center text-blue-600 shadow-xl group-hover:scale-110 transition-transform"><Fingerprint size={32} /></div>
                                            <div>
                                                <h4 className="text-xl font-black tracking-tight">Doble Factor (2FA)</h4>
                            ...
                            {activeTab === 'appearance' && (
                                ...
                                >
                                    ...
                                    <div className="p-10 bg-slate-50 dark:bg-black/20 rounded-[3rem] border border-slate-100 dark:border-white/5 space-y-8">
                                        <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em]">Idioma y Localización</h3>
                                        <div className="flex items-center justify-between p-6 bg-white dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/10 shadow-sm cursor-pointer hover:border-blue-500/30 transition-all group">
                                            <div className="flex items-center gap-4">
                                                <Globe size={24} className="text-slate-400 group-hover:text-blue-500 transition-colors" />
                                                <div>
                                                    <p className="text-sm font-black tracking-tight">Español (Latinoamérica)</p>
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Predeterminado</p>
                                                </div>
                                            </div>
...
function InputField({ label, icon: Icon, value, placeholder, type = "text" }: any) {
    return (
        <div className="space-y-3">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2 leading-none block">{label}</label>
            <div className="relative group">
                ...
                <input
                    ...
                    className={clsx(
                        "w-full bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-2xl py-4 pr-6 text-[14px] font-bold text-slate-700 dark:text-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/50 focus:bg-white dark:focus:bg-black/60 outline-none transition-all",
                        Icon ? "pl-14" : "pl-6"
                    )}
                />
            </div>
...
function ThemeCard({ label, icon: Icon, active }: any) {
    return (
        <div className={clsx(
            "p-8 rounded-[2.5rem] border-2 cursor-pointer transition-all flex flex-col items-center gap-6 group relative overflow-hidden",
            active 
            ...
            <div className={clsx(
                "size-16 rounded-[1.5rem] flex items-center justify-center transition-all duration-500 group-hover:rotate-12",
                active ? "bg-blue-600 text-white shadow-2xl" : "bg-slate-100 dark:bg-white/5 text-slate-400 group-hover:text-blue-500"
            )}>
                <Icon size={32} />
            </div>
            <span className={clsx("text-[11px] font-black uppercase tracking-[0.2em]", active ? "text-blue-600 dark:text-white" : "text-slate-500")}>{label}</span>
        </div>
    );
}
