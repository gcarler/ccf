            ...
            <div className="mx-auto flex h-full max-w-5xl items-center px-4 py-1.5">
                <section className="grid w-full grid-cols-1 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl dark:border-white/10 dark:bg-white/5 lg:grid-cols-[1fr_0.9fr]">
                    <div className="space-y-6 p-4 lg:p-4">
                        <div>
                            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-blue-500">Lienzo colaborativo</p>
                        ...
                        <label className="block space-y-2">
                            <span className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">Nombre</span>
                            <input
                                value={title}
                                onChange={(event) => setTitle(event.target.value)}
                                placeholder="Ej: Planeacion Faro Q2"
                                className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold outline-none focus:border-blue-400 dark:border-white/10 dark:bg-black/20"
                            />
                        </label>

                        <label className="block space-y-2">
                            <span className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">Objetivo</span>
                            <textarea
                                value={description}
                                onChange={(event) => setDescription(event.target.value)}
                                placeholder="Describe que se va a construir en este lienzo..."
                                className="min-h-[140px] w-full resize-none rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold outline-none focus:border-blue-400 dark:border-white/10 dark:bg-black/20"
                            />
                        </label>
                    ...
                    <div className="relative min-h-[420px] overflow-hidden bg-slate-950 p-4 text-white">
                        ...
                        <div className="relative flex h-full flex-col justify-between rounded-lg border border-white/10 bg-white/10 p-3 backdrop-blur">
                            ...
                            <div>
                                <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-blue-200">Preview</p>
