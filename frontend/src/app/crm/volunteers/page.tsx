                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {['Todos', ...TEAMS].map(t => (
                                            <button
                                                ...
                                                className={`px-3 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-wide transition-all ${teamFilter === t ? 'bg-blue-600 text-white shadow-md' : 'bg-slate-100 dark:bg-white/5 text-slate-500 hover:bg-slate-200 dark:hover:bg-white/10'}`}
                                            >
                                                {t}
                                            </button>
                                        ))}
                        ...
                        {showAddForm && (
                            <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="bg-white dark:bg-[#252528] rounded-lg border border-blue-200 dark:border-blue-700/30 p-4 shadow-xl">
                                ...
                                <div className="flex justify-end gap-3 mt-5">
                                    <button onClick={() => setShowAddForm(false)} className="px-4 py-2.5 text-[11px] font-bold uppercase tracking-wide text-slate-500 bg-slate-100 dark:bg-white/5 rounded-xl hover:bg-slate-200 transition-colors">Cancelar</button>
                                    <button onClick={handleSave} disabled={saving} className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-xl text-[11px] font-bold uppercase tracking-wide shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all active:scale-95 disabled:opacity-60">
                                        ...
                                        {members.map((v, idx) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-start justify-between mb-3">
                                                    <div className={`size-8 rounded-xl bg-gradient-to-br ${getTeamColor(team)} flex items-center justify-center text-white text-xs font-bold shadow-md`}>
