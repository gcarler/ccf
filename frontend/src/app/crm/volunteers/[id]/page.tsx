...
function Badge({ label, tone = "blue" }: { label: string; tone?: string }) {
    ...
    return (
        <span className={clsx("inline-flex items-center px-3 py-1 rounded-xl border text-[9px] font-bold uppercase tracking-wide", styles[tone] ?? styles.blue)}>
            {label}
        </span>
    );
}
                    ...
                    <header className="bg-white dark:bg-[#15171c] rounded-lg border border-slate-200 dark:border-white/5 p-3 lg:p-4 shadow-sm flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                            <button onClick={openEdit}
                                className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl text-[10px] font-bold uppercase tracking-wide shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all">
                    ...
                    <>
                        ...
                        <motion.aside
                            ...
                            <div className="p-3 border-t border-slate-100 dark:border-white/5 flex gap-3">
                                <button onClick={() => setEditOpen(false)}
                                    className="flex-1 py-3 rounded-xl border border-slate-200 dark:border-white/10 text-[10px] font-bold uppercase tracking-wide text-slate-500 hover:bg-slate-50 transition-all">
                                    Cancelar
                                </button>
                                <button onClick={handleSave} disabled={saving}
                                    className="flex-1 py-3 rounded-xl bg-blue-600 text-white text-[10px] font-bold uppercase tracking-wide shadow-lg shadow-blue-500/20 hover:bg-blue-700 disabled:opacity-50 transition-all flex items-center justify-center gap-2">
                            ...
                            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }}
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button onClick={handleDelete} disabled={deleting}
                                        className="flex-1 py-3 rounded-xl bg-rose-600 text-white text-[10px] font-bold uppercase tracking-wide shadow-lg shadow-rose-500/20 hover:bg-rose-700 disabled:opacity-50 transition-all">
