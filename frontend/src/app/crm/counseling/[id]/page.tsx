            ...
            <main className="flex-1 overflow-y-auto p-4 lg:p-4">
                <div className="max-w-4xl mx-auto space-y-3">
                    <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                        ...
                        <button className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-500/20 hover:scale-105 transition-all">
                            Cerrar sesion
                        </button>
                    </header>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div className="lg:col-span-2 space-y-3">
                            <DSCard>
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Resumen de la Sesion</h3>
                            ...
                            <DSCard>
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Notas confidenciales</h3>
                                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                        ...
                        <aside className="space-y-3">
                            <DSCard>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-[9px] font-black text-slate-400 uppercase">Pastor ID</p>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-[9px] font-black text-slate-400 uppercase">Duracion</p>
                            ...
                            <DSCard>
                                <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Historial</h3>
                                <div className="space-y-3">
                                    {session.history.length > 0 ? session.history.map((item) => (
                                        <div key={item.id} className="rounded-2xl border border-slate-100 dark:border-white/5 p-3">
