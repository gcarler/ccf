    ...
    return (
        <div className="p-4 lg:p-4 space-y-12 max-w-3xl mx-auto animate-in fade-in duration-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                {/* Hero / Instruction */}
                <div className="bg-[hsl(var(--surface-2))] border border-[hsl(var(--border))] rounded-xl p-4 md:p-5 shadow-sm relative overflow-hidden">
                ...
                <section className="space-y-3">
                    ...
                    <div className="relative group">
                        <div className="absolute -inset-1 bg-gradient-to-br from-[hsl(var(--primary))] to-transparent opacity-0 group-focus-within:opacity-10 transition-opacity rounded-xl blur-xl"></div>
                ...
                <section className="space-y-3">
                    ...
                    <div className="border-2 border-dashed border-[hsl(var(--border))] hover:border-[hsl(var(--primary)/0.5)] rounded-xl p-4 flex flex-col items-center justify-center bg-[hsl(var(--surface-2))] hover:bg-[hsl(var(--surface-3))] transition-all cursor-pointer group scale-in duration-500">
                ...
                <motion.button
                    ...
                    className="w-full h-16 bg-[hsl(var(--primary))] text-white rounded-xl font-black uppercase tracking-[0.2em] text-xs shadow-2xl shadow-primary/30 hover:opacity-95 disabled:opacity-50 transition-all flex items-center justify-center gap-3"
                >
                    {isSubmitting ? (
