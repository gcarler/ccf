...
export default function NotificationsCenter() {
    ...
    return (
        <div className="p-4 lg:p-4 animate-in fade-in duration-700 max-w-4xl mx-auto">
            <header className="flex items-center justify-between mb-12">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="px-4 py-2 hover:bg-[hsl(var(--surface-2))] rounded-xl text-[10px] font-black text-[hsl(var(--text-secondary))] uppercase tracking-widest transition-colors flex items-center gap-2"
                    >
            ...
            {loading ? (
                <div className="py-24 text-center text-sm font-black uppercase tracking-[0.25em] text-[hsl(var(--text-secondary))]">
    ...
    return (
        <section>
            <div className="flex items-center gap-4 mb-6">
                <h3 className="text-[hsl(var(--text-secondary))] text-[10px] font-black uppercase tracking-[0.2em]">{title}</h3>
                    ...
                    >
                        ...
                        <div className="flex-1 pr-8">
                            <div className="flex justify-between items-start mb-1">
                                <h4 className={`text-sm font-black tracking-tight ${!notification.read ? 'text-[hsl(var(--text-primary))]' : 'text-[hsl(var(--text-secondary))]'}`}>
                                    {notification.title}
                                </h4>
                                <span className="text-[9px] font-black text-[hsl(var(--text-secondary))] uppercase tracking-widest">
