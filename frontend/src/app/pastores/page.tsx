    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] dark:bg-[#0b0d11] selection:bg-blue-500/30 selection:text-blue-900">
            ...
            <main className="pt-24 pb-20">
                {/* Hero Section */}
                <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-20 text-center relative z-10 pt-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 text-xs font-black uppercase tracking-widest mb-6 border border-blue-200 dark:border-blue-500/20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {PASTORS.map((pastor, idx) => (
                            <Link 
                                ...
                                key={pastor.id}
                                className="group relative bg-white dark:bg-[#13161c] rounded-[2rem] overflow-hidden border border-slate-200 dark:border-white/5 shadow-xl shadow-slate-200/20 dark:shadow-none hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500 flex flex-col"
                                style={{ animationDelay: `${idx * 100}ms` }}
                            >
                                {/* Imagen Wrapper */}
                                <div className="relative h-72 w-full bg-slate-100 dark:bg-black overflow-hidden">
                                    <Image 
                                        src={pastor.image} 
                                        alt={pastor.name}
                                        fill
                                    ...
                                    <div className="absolute bottom-4 left-5 right-5">
                                        <h3 className="text-2xl font-black text-white">{pastor.name}</h3>
