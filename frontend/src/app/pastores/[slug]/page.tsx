                ...
                <div className="bg-slate-50 dark:bg-[#0f1117] py-1.5 border-t border-slate-200 dark:border-white/5">
                    <div className="max-w-3xl mx-auto px-3 lg:px-4">
                        ...
                        <div 
                            ...
                            prose-blockquote:border-l-blue-500 prose-blockquote:bg-white dark:prose-blockquote:bg-[#151821] prose-blockquote:py-1.5 prose-blockquote:px-3 prose-blockquote:rounded-r-2xl prose-blockquote:font-medium prose-blockquote:text-slate-800 dark:prose-blockquote:text-slate-200 prose-blockquote:shadow-sm"
