                ...
                <div className="mx-auto max-w-6xl space-y-6 p-6 lg:p-8">
                    <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#1e1f21]">
                        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
                            <div>
                                <p className="text-[11px] font-black uppercase tracking-[0.18em] text-slate-400">Agenda de iglesia</p>
                                <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900 dark:text-white">Eventos sin seguimiento de asistencia</h1>
                    ...
                    <section className="grid gap-6 lg:grid-cols-[380px,1fr]">
                        <form onSubmit={handleCreate} className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#1e1f21]">
                            <div className="mb-5 flex items-center gap-3">
                                <div className="flex size-11 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 dark:bg-blue-500/10 dark:text-blue-400">
                                    <Plus size={18} />
                                </div>
                                <div>
                                    <h2 className="text-sm font-black uppercase tracking-widest text-slate-900 dark:text-white">Nuevo evento de agenda</h2>
                            ...
                            <button
                                ...
                                className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-[11px] font-black uppercase tracking-widest text-white transition-all hover:bg-blue-700 disabled:opacity-50"
                            >
                                <Plus size={14} />
                        ...
                        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#1e1f21]">
                            <div className="mb-5 flex items-center justify-between gap-3">
                                <div>
                                    <h2 className="text-sm font-black uppercase tracking-widest text-slate-900 dark:text-white">Próximos eventos</h2>
                            ...
                            {loading ? (
                                <div className="grid gap-4">
                                    {Array.from({ length: 4 }).map((_, index) => (
                                        <div key={index} className="h-28 animate-pulse rounded-[1.5rem] bg-slate-100 dark:bg-white/5" />
                                    ))}
                                </div>
                                ...
                                <div className="space-y-4">
                                    {sortedEvents.map((event) => (
                                        <article
                                            key={event.id}
                                            className="rounded-[1.75rem] border border-slate-200 p-5 transition-colors hover:border-blue-300 dark:border-white/10 dark:hover:border-blue-500/30"
                                        >
                                            {editingEventId === event.id ? (
                                                <div className="space-y-4">
                                                    <div className="flex items-center justify-between gap-3">
                                                        <span className="rounded-full bg-amber-50 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-amber-600 dark:bg-amber-500/10 dark:text-amber-400">
                                                            Edición rápida
                                                        </span>
                                                        <div className="flex gap-2">
                                                            <button
                                                                ...
                                                                className="inline-flex items-center gap-1 rounded-xl border border-red-200 px-3 py-2 text-[11px] font-black uppercase tracking-widest text-red-600 transition-all hover:bg-red-50 disabled:opacity-50 dark:border-red-500/20 dark:hover:bg-red-500/10"
                                                            >
                                                                <Trash2 size={12} />
                                                            ...
                                                            <button
                                                                ...
                                                                className="inline-flex items-center gap-1 rounded-xl border border-slate-200 px-3 py-2 text-[11px] font-black uppercase tracking-widest text-slate-500 transition-all hover:bg-slate-50 dark:border-white/10 dark:hover:bg-white/5"
                                                            >
                                                                <X size={12} />
                                                                Cancelar
                                                            </button>
                                                            <button
                                                                ...
                                                                className="inline-flex items-center gap-1 rounded-xl bg-blue-600 px-3 py-2 text-[11px] font-black uppercase tracking-widest text-white transition-all hover:bg-blue-700 disabled:opacity-50"
                                                            >
                                                                <Save size={12} />
                                                ...
                                                <>
                                                    <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <span className="rounded-full bg-blue-50 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-blue-600 dark:bg-blue-500/10 dark:text-blue-400">
                                                                Agenda simple
                                                            </span>
                                                            <button
                                                                onClick={() => handleInlineDelete(event.id)}
