                ...
                <section className="rounded-[2rem] border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
                    <header className="flex flex-col gap-4 border-b border-slate-100 p-5 dark:border-white/10 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <h1 className="text-2xl font-black text-slate-900 dark:text-white">Estudiantes</h1>
                        </div>
                        ...
                        <table className="min-w-full text-sm">
                            ...
                            <tbody>
                                {filtered.map((student) => (
                                    ...
                                    >
                                        <td className="px-6 py-4 font-black text-slate-900 dark:text-white">{student.full_name || student.name || "Estudiante"}</td>
                                        <td className="px-6 py-4 text-slate-500">{student.email || "Sin correo"}</td>
                                        <td className="px-6 py-4 text-slate-500">{student.course_count ?? 0}</td>
                                        <td className="px-6 py-4 text-slate-500">{student.progress ?? 0}%</td>
