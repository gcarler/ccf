            ...
            <div className="relative group mb-6 rounded-[2.5rem] border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111418] p-6">
                ...
                <div className="flex gap-2 mt-4">
                    ...
                    <button
                        ...
                        className="ml-auto text-[11px] font-black uppercase tracking-widest text-slate-400 hover:text-primary"
                    >
                        Actualizar
                    </button>
                </div>
            ...
            {favoriteResources.length > 0 && (
                <section className="py-6 flex flex-col gap-3 rounded-[2.5rem] border border-slate-200 dark:border-white/10 bg-white/70 dark:bg-[#16191d] p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{favoriteResources.length}</span>
                    </div>
    ...
    return (
        <article className="bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 hover:border-primary/30 rounded-[2rem] p-5 flex items-center gap-5 shadow-xl transition-all">
            ...
            <div className="flex flex-col flex-1 min-w-0">
                <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1">{resource.courseTitle}</p>
                ...
                <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-3">{resource.duration}</p>
            </div>
