...
export default function CourseCoordinationPage() {
    ...
    if (loading) return (
        <div className="flex items-center justify-center h-full p-5 text-slate-500 font-black uppercase tracking-[0.3em] animate-pulse">
            Sincronizando Malla Curricular...
        </div>
    );

    if (!course) return (
        <div className="flex flex-col items-center justify-center h-full p-5 text-center space-y-4">
            ...
            <main className="flex-1 overflow-y-auto p-4 lg:p-4 space-y-3">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div className="lg:col-span-2 space-y-3">
                        <DSCard>
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Estado de Alistamiento Académico</h3>
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="size-8 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-600">
                                            <Calendar size={20} />
                                        </div>
                                        <div>
                        ...
                        <DSCard>
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Actas y Certificación</h3>
                            <div className="p-4 text-center bg-slate-50 dark:bg-white/5 rounded-xl border border-dashed border-slate-200 dark:border-white/10">
                    ...
                    <div className="space-y-3">
                        <DSCard>
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Acciones de Control</h3>
                            <div className="space-y-3">
                                <button className="w-full flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-white/5 hover:bg-blue-600 hover:text-white transition-all group text-left">
                        ...
                        <div className="bg-indigo-600 rounded-xl p-4 text-white space-y-4 shadow-xl shadow-indigo-500/20">
                            <h4 className="text-sm font-black uppercase tracking-tight">Optimus Coach</h4>
