            ...
            <main className="flex-1 overflow-y-auto p-8 lg:p-12">
                <div className="max-w-4xl mx-auto space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-transparent border-b-2 border-slate-100 dark:border-white/5 py-3 text-2xl font-black outline-none focus:border-blue-500 transition-all"
                                />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl py-3 px-4 text-sm outline-none focus:ring-4 focus:ring-blue-500/10"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <textarea 
                                            ...
                                            className="w-full bg-transparent border-none text-lg font-bold outline-none resize-none placeholder:text-slate-300"
                                            rows={2}
                                        />
                        ...
                        {questions.length === 0 && (
                            <div className="p-20 text-center border-2 border-dashed border-slate-200 dark:border-white/10 rounded-[2.5rem]">
