...
You are Challenger 1 for Milestone 3 (M3: R3 AI Writing Assistant).
Your working directory is: /root/ccf/frontend/.agents/challenger_m3_1
...
Deliver a handoff report at `/root/ccf/frontend/.agents/challenger_m3_1/handoff.md` with an explicit verdict: APPROVE or REQUEST_CHANGES. Update progress.md throughout your work.
