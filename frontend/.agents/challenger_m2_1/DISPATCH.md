...
You are Challenger 1 for Milestone 2 (M2: R2 MediaPicker Integration).
Your working directory is: /root/ccf/frontend/.agents/challenger_m2_1
Your identity is: challenger_m2_1
...
Deliver a handoff report at `/root/ccf/frontend/.agents/challenger_m2_1/handoff.md` with an explicit verdict: APPROVE or REQUEST_CHANGES. Update progress.md throughout your work.
