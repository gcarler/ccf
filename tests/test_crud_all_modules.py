...
class TestCMSSites:
    ...
    def test_update_site(self, db_session):
        ...
        site = create_cms_site(
            db_session, CmsSiteCreate(site_key=f"u_{uuid.uuid4().hex[:6]}", name="U", base_path="/u")
        )
    ...
    def test_archive_site(self, db_session):
        ...
        site = create_cms_site(
            db_session, CmsSiteCreate(site_key=f"a_{uuid.uuid4().hex[:6]}", name="A", base_path="/a")
        )
...
class TestCMSThemes:
    ...
    def test_create_theme(self, db_session):
        ...
        theme = create_cms_theme(
            db_session,
            site,
            CmsThemeCreate(name="Theme1", tokens_json={}, is_active=True, status="active"),
            created_by=None,
        )
    ...
    def test_get_theme(self, db_session):
        ...
        theme = create_cms_theme(
            db_session,
            site,
            CmsThemeCreate(name="T2", tokens_json={}, is_active=False, status="archived"),
            created_by=None,
        )
    ...
    def test_update_theme(self, db_session):
        ...
        theme = create_cms_theme(
            db_session,
            site,
            CmsThemeCreate(name="T3", tokens_json={}, is_active=False, status="archived"),
            created_by=None,
        )
    ...
    def test_activate_theme(self, db_session):
        ...
        theme = create_cms_theme(
            db_session,
            site,
            CmsThemeCreate(name="Act", tokens_json={}, is_active=False, status="archived"),
            created_by=None,
        )
    ...
    def test_archive_theme(self, db_session):
        ...
        theme = create_cms_theme(
            db_session,
            site,
            CmsThemeCreate(name="Arch", tokens_json={}, is_active=False, status="archived"),
            created_by=None,
        )
...
class TestCMSPages:
    ...
    def test_create_page(self, db_session):
        ...
        page = create_cms_page(
            db_session, site, CmsPageCreate(slug="test-page", title="Test Page", status="draft"), user_id=None
        )
    ...
    def test_sections(self, db_session):
        ...
        section = create_cms_section(
            db_session, page.id, CmsSectionCreate(section_key="hero", type="Hero", props_json={})
        )
    ...
    def test_page_versions(self, db_session):
        ...
        page = create_cms_page(
            db_session,
            site,
            CmsPageCreate(slug=f"pv_{uuid.uuid4().hex[:6]}", title="PV", status="draft"),
            user_id=None,
        )
...
class TestAcademyCourses:
    def test_create_course(self, db_session):
        ...
        course = create_course(
            db_session,
            {"title": f"Course {uuid.uuid4().hex[:6]}", "code": f"C{uuid.uuid4().hex[:4]}", "modality": "virtual"},
        )
    ...
    def test_create_lesson(self, db_session):
        ...
        lesson = create_lesson(
            db_session, course.id, {"title": "Lesson 1", "order_index": 1, "content": "Lesson content"}
        )
...
class TestProjects:
    ...
    def test_get_project(self, db_session, admin_data):
        ...
        project = create_project(
            db_session,
            ProjectCreate(title="GP", description="d"),
            owner_persona_id=str(persona.id),
            sede_id=str(sede.id),
        )
    ...
    def test_update_project(self, db_session, admin_data):
        ...
        project = create_project(
            db_session,
            ProjectCreate(title="UP", description="d"),
            owner_persona_id=str(persona.id),
            sede_id=str(sede.id),
        )
    ...
    def test_delete_project(self, db_session, admin_data):
        ...
        project = create_project(
            db_session,
            ProjectCreate(title="DP", description="d"),
            owner_persona_id=str(persona.id),
            sede_id=str(sede.id),
        )
    ...
    def test_project_tasks(self, db_session, admin_data):
        ...
        project = create_project(
            db_session,
            ProjectCreate(title="PT", description="d"),
            owner_persona_id=str(persona.id),
            sede_id=str(sede.id),
        )
    ...
    def test_project_milestones(self, db_session, admin_data):
        ...
        project = create_project(
            db_session,
            ProjectCreate(title="PM", description="d"),
            owner_persona_id=str(persona.id),
            sede_id=str(sede.id),
        )
    ...
    def test_project_comments(self, db_session, admin_data):
        ...
        project = create_project(
            db_session,
            ProjectCreate(title="PC", description="d"),
            owner_persona_id=str(persona.id),
            sede_id=str(sede.id),
        )
