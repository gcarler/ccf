...
class TestEventInvitation:
    def test_evento(self):
        assert "Conferencia" in render_event_invitation(
            {"nombre": "P", "evento": "Conferencia", "fecha": "15 Ago", "hora": "18:00", "lugar": "Aud", "link": "#"}
        )
...
class TestCounselingReminder:
    def test_fecha(self):
        assert "2026-07-15" in render_counseling_reminder(
            {"nombre": "L", "fecha": "2026-07-15", "hora": "14:00", "pastoral_name": "P"}
        )
