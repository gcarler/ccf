"""
BRANCH COVERAGE v4 — Tests error paths, validations, partial updates, optional filters.
"""
import uuid
import pytest
...
class TestEvangelismBranchesV4:
...
class TestEnterpriseCMSBranchesV4:
...
class TestDonationsFinanceBranchesV4:
