"""
BRANCH COVERAGE v3 — Tests error paths, validations, partial updates, optional filters.
These are the code paths that existing happy-path tests miss.
"""
import uuid
import pytest
...
# ═══════════════════════════════════════════════════════════════════════════════
# PASTORAL — ERROR PATHS + VALIDATIONS + PARTIAL UPDATES
# ═══════════════════════════════════════════════════════════════════════════════

class TestPastoralBranches:
...
# ═══════════════════════════════════════════════════════════════════════════════
# CMS V2 — ERROR PATHS + VALIDATIONS
# ═══════════════════════════════════════════════════════════════════════════════

class TestCMSBranches:
...
# ═══════════════════════════════════════════════════════════════════════════════
# EVANGELISM — ERROR PATHS + VALIDATIONS
# ═══════════════════════════════════════════════════════════════════════════════

class TestEvangelismBranches:
...
# ═══════════════════════════════════════════════════════════════════════════════
# ENTERPRISE CMS — ERROR PATHS
# ═══════════════════════════════════════════════════════════════════════════════

class TestEnterpriseCMSBranches:
...
# ═══════════════════════════════════════════════════════════════════════════════
# DONATIONS + FINANCE — ERROR PATHS
# ═══════════════════════════════════════════════════════════════════════════════

class TestDonationsFinanceBranches:
