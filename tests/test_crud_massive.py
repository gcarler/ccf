...
class TestCRMPersonaRead:
    def test_get_persona(self, db_session):
        ...
        p = create_persona(
            db_session, PersonaCreate(first_name="Read", last_name="Test", email=f"r_{uuid.uuid4().hex[:6]}@e.com")
        )
...
class TestCRMPersonaUpdate:
    def test_update_persona(self, db_session):
        ...
        p = create_persona(
            db_session, PersonaCreate(first_name="Old", last_name="Name", email=f"u_{uuid.uuid4().hex[:6]}@e.com")
        )
...
class TestCRMPersonaDelete:
    def test_delete_persona(self, db_session):
        ...
        p = create_persona(
            db_session, PersonaCreate(first_name="Del", last_name="User", email=f"d_{uuid.uuid4().hex[:6]}@e.com")
        )
...
class TestCRMSearch:
    def test_search_personas(self, db_session):
        ...
        create_persona(
            db_session,
            PersonaCreate(first_name="Searchable", last_name="Person", email=f"s_{uuid.uuid4().hex[:6]}@e.com"),
        )
    ...
    def test_search_personas(self, db_session):
        ...
        create_persona(
            db_session, PersonaCreate(first_name="Persona", last_name="Search", email=f"m_{uuid.uuid4().hex[:6]}@e.com")
        )
...
class TestCRMCounseling:
    def test_create_counseling_ticket(self, db_session):
        ...
        ticket = create_counseling_ticket(
            db_session,
