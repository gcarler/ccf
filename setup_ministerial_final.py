...
def create_admin():
    ...
    try:
        ...
        if person:
            print(f"Admin {person.email} ya existe en el sistema.")
            return

        print("Creando Administrador Ministerial Final v3.9...")
        ...
        db.commit()
        print("¡ACTUALIZACION EXITOSA! Administrador ministerial creado en PostgreSQL.")
