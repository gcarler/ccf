...
def stress_test_data(num_users=1000, num_members=5000, num_tasks=10000):
    db = SessionLocal()
    try:
        print(f"🚀 Iniciando Stress Test de Datos: {num_users} usuarios, {num_members} miembros, {num_tasks} tareas...")
        ...
        for i in range(num_members):
            member = models.Member(
                ...
                spiritual_status=random.choice(["Nuevo", "Creyente", "Discípulo", "Servidor"]),
