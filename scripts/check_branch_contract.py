...
MODULE_PREFIXES: dict[str, tuple[str, ...]] = {
    ...
    "cms": (
        ...
        "frontend/src/app/(public)/cursos/",
        "frontend/src/app/(public)/nosotros/",
        "frontend/src/app/(public)/PublicHomePage.tsx",
        "frontend/public/aniversario40/",
        "frontend/src/components/public/",
        "frontend/src/hooks/useCmsV2Page.ts",
        "frontend/src/lib/cms/",
        "frontend/src/lib/data/cursos.ts",
        ...
        "docs/ESTADO_CMS.md",
        "docs/PLAN_CMS_",
        "docs/INFORME_AUDITORIA_CURSOS_PUBLICOS_",
    ),
    "crm": (
        "backend/api/crm",
        "backend/crud/crm",
