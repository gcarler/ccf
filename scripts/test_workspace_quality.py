#!/usr/bin/env python3
"""
Canonical quality smoke for Workspace module.

Usage:
    python scripts/test_workspace_quality.py [--backend-deep]
...
def main():
    gates = [
        (
            "🧪 Workspace API tests",
            [VENV_PYTHON, "-m", "pytest", "tests/test_workspace_api.py", "-q", "--tb=short", "--no-cov"],
        ),
    ...
    if all_ok:
        print("\n✅ ALL GATES PASS — Workspace module is healthy.")
    else:
