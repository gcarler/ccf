...
def seed():
    ...
    testimonials = [
        {
            "content": "Increíble plataforma, me encanta la interfaz.",
            "emotion": "Inspirado",
            "author_id": user_id,
        },
        {
            "content": "El CRM me ha facilitado mucho el trabajo con mi equipo.",
            "emotion": "Agradecido",
            "author_id": user_id,
        },
        {
            "content": "Esperando con ansias los nuevos cursos de la academia.",
            "emotion": "Motivado",
            "author_id": user_id,
        },
    ]
    ...
    for t in testimonials:
        ...
        if res.status_code in (200, 201):
            ...
            if "Interfaz" in t["content"]:
                t_id = res.json()["id"]
                requests.patch(
                    f"{BASE_URL}/api/admin/testimonials/{t_id}",
