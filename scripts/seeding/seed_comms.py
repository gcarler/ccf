...
def seed_communications_ecosystem_v2():
    ...
    """,
        (
            project_id,
            "PROYECTO: Comunicación Organizacional",
    ...
    """,
        (
            project_id,
            "PROYECTO: Talleres de Co-creación",
    ...
    dashboard_elements = [
        {
            ...
            "x": 50,
            "y": 50,
            "text": "Dashboard de Comunicaciones CCF",
            "fontSize": 24,
            "fontWeight": "bold",
        },
        {
    ...
    """,
        (
            project_id,
            "Panel de Control Comunicaciones",
            json.dumps(dashboard_elements),
            now.isoformat(),
            now.isoformat(),
        ),
    )
