...
CURSOS = [
    {
        ...
        "lecciones": [
            (
                "¿Qué es exactamente el 'euangelion'?",
                "video",
                45,
            ...
            (
                "Gracia barata vs. gracia costosa (Bonhoeffer)",
                "texto",
                50,
            ...
            (
                "El problema del moralismo evangélico contemporáneo",
                "video",
                55,
            ...
            (
                "Síntesis: El evangelio como ecosistema, no como fórmula",
                "video",
                60,
    ...
    },
    {
        ...
        "lecciones": [
            (
                "El Mediterráneo del siglo I: el mundo donde nació Jesús",
                "video",
                55,
            ...
            (
                "Las fuentes históricas: ¿qué sabemos con certeza?",
                "video",
                60,
            ...
            (
                "Jesús y las mujeres: la revolución silenciosa",
                "video",
                50,
            ...
            (
                "La entrada a Jerusalén: provocación calculada",
                "video",
                45,
            ...
            (
                "El proceso y la crucifixión: ¿por qué lo mataron?",
                "video",
                70,
            ...
            (
                "La resurrección: historia, teología y consecuencias",
                "video",
                75,
    ...
    },
    {
        ...
        "lecciones": [
            (
                "¿De dónde viene el 'rapto'? Historia de una idea de 200 años",
                "video",
                50,
            ...
            (
                "Apocalipsis 101: contexto, autor, destinatarios y propósito",
                "video",
                60,
            ...
            (
                "Leer símbolos, no noticias: la clave hermenéutica",
                "texto",
                55,
            ...
            (
                "La cosmología del Apocalipsis: cielo, tierra y el trono",
                "video",
                50,
            ...
            (
                "El Milenio a través de la historia de la iglesia",
                "video",
                65,
            ...
            (
                "'Casi se acaba el mundo': cómo las fechas erróneas revelan el problema",
                "video",
                45,
            ...
            (
                "Escatología del Nuevo Testamento: más allá del Apocalipsis",
                "texto",
                55,
            ...
            (
                "Esperanza que transforma el presente: escatología como ética",
                "video",
                60,
    ...
    },
    {
        ...
        "lecciones": [
            (
                "El problema del mal: formulación filosófica clásica",
                "video",
                60,
            ...
            (
                "Job: el libro más honesto de la Biblia",
                "texto",
                70,
            ...
            (
                "El libre albedrío como respuesta: Plantinga y sus límites",
                "video",
                60,
            ...
            (
                "Auschwitz: el punto donde la teodicea tradicional muere",
                "video",
                65,
            ...
            (
                "Dolor, lamentación y espiritualidad: los Salmos de queja",
                "video",
                50,
            ...
            (
                "La resurrección como respuesta final al sufrimiento",
                "video",
                65,
    ...
    },
    {
        ...
        "lecciones": [
            (
                "La ilusión de la apoliticidad cristiana",
                "video",
                55,
            ...
            (
                "Constantino, 313 d.C.: el momento en que todo cambió",
                "video",
                60,
            ...
            (
                "Los profetas como disidentes políticos",
                "texto",
                55,
            ...
            (
                "El Sermón del Monte: las Bienaventuranzas como política alternativa",
                "video",
                65,
            ...
            (
                "Karl Barth y el No a Hitler: cuando la teología fue resistencia",
                "video",
                50,
            ...
            (
                "John Howard Yoder: la política de Jesús",
                "texto",
                60,
            ...
            (
                "Idolatría política: cuando adoramos banderas y partidos",
                "video",
                50,
            ...
            (
                "Hacia una ética política cristiana para el siglo XXI",
                "video",
                65,
    ...
    },
    {
        ...
        "lecciones": [
            (
                "Génesis 1-2: ¿dominio o mayordomía?",
                "video",
                55,
            ...
            (
                "Lynn White y el cargo de culpabilidad cristiana",
                "texto",
                50,
            ...
            (
                "'La creación entera gime': exégesis de Romanos 8:18-23",
                "video",
                55,
            ...
            (
                "Escatología verde: si el mundo no 'se va a quemar', ¿qué pasa?",
                "video",
                60,
            ...
            (
                "Consumo, capitalismo y el pecado de la codicia sistémica",
                "video",
                55,
            ...
            (
                "Espiritualidad encarnada: vivir el cuidado de la creación",
                "texto",
                50,
