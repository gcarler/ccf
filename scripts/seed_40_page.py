    ...
    try:
        ...
        if not page:
            page = CmsPage(
                ...
                seo_json={
                    "title": "40 Años Iluminando Generaciones",
                    "description": "Celebra con nosotros cuatro décadas de luz en la Comunidad Cristiana CCF.",
                },
            )
            db.add(page)
            db.flush()
                    ...
                    "events": [
                        {
                            "year": "1986",
                            "title": "El Comienzo",
                            "description": "Un pequeño grupo de familias se reúne con una visión gigante.",
                        }
                    ],
                },
            },
