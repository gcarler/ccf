#!/usr/bin/env python3
"""
Canonical quality smoke for Finance module.

Usage:
    python scripts/test_finance_quality.py [--backend-deep]
...
def main():
    gates = [
        (
            "🧪 Finance API tests",
            [VENV_PYTHON, "-m", "pytest", "tests/test_finance_api.py", "-q", "--tb=short", "--no-cov"],
        ),
    ...
    if all_ok:
        print("\n✅ ALL GATES PASS — Finance module is healthy.")
    else:
