...
def run():
    ...
    if not table_exists("personas"):
        ...
        db.execute(text("""
            CREATE TABLE personas (
                ...
                origen_grupo_id INTEGER REFERENCES grupos_evangelismo(id) ON DELETE SET NULL,
    ...
    fk_migrations = [
        ...
        ("grupos_evangelismo", "leader_id", "leader_persona_id", True, "SET NULL"),
        ("grupos_evangelismo", "assistant_id", "assistant_persona_id", True, "SET NULL"),
        ("grupos_evangelismo", "host_id", "host_persona_id", True, "SET NULL"),
        ("grupo_participantes", "member_id", "persona_id", False, "CASCADE"),
        ("sesiones_grupo", "reported_by_member_id", "reported_by_persona_id", True, "SET NULL"),
        ("asistencias", "member_id", "persona_id", False, "CASCADE"),
