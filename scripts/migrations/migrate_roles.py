...
ROLES = [
    {
        "name": "Todos",
        "color": "text-slate-600 bg-slate-100 dark:bg-white/10 dark:text-slate-400",
        "is_leadership": False,
    },
    {
        "name": "Apóstol",
    ...
    {
        "name": "Visitante Servicios",
        "color": "text-slate-600 bg-slate-100 dark:bg-white/10 dark:text-slate-400",
        "is_leadership": False,
    },
    {
        "name": "Visitante Faro en Casa",
