...
def main():
    ...
    try:
        ...
        if yane:
            ...
            yane.bio_short = (
                "La fuerza inquebrantable de una mujer virtuosa, la intercesión y la compasión por los vulnerables."
            )
            yane.bio_full = (
            ...
            # Buscar alternativas
            alt = db.query(models.Persona).filter(models.Persona.first_name.ilike("%yanedith%")).all()
            if alt:
