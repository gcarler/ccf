...
CREATE TABLE IF NOT EXISTS courses (
    ...
    certificate_type VARCHAR(50) DEFAULT 'Participacion',
...
CREATE INDEX IF NOT EXISTS ix_consolidation_assignments_start_date ON consolidation_assignments(start_date);
CREATE INDEX IF NOT EXISTS ix_consolidation_assignments_end_date ON consolidation_assignments(end_date);
CREATE INDEX IF NOT EXISTS ix_consolidation_assignments_status ON consolidation_assignments(status);
CREATE INDEX IF NOT EXISTS ix_consolidation_assignments_created_at ON consolidation_assignments(created_at);


-- ============================================================================
-- 7. PROJECTS  (added for migration compatibility)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS ix_projects_title ON projects(title);
...
CREATE INDEX IF NOT EXISTS ix_project_tasks_status ON project_tasks(status);
CREATE INDEX IF NOT EXISTS ix_project_tasks_assignee_id ON project_tasks(assignee_id);
