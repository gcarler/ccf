"""add_cms_newsletter — tables for CMS newsletter campaigns and subscribers (R2)

Revision ID: 20260730_0006_add_cms_newsletter
...
revision = "20260730_0006_add_cms_newsletter"
...
def downgrade() -> None:
    ...
    if inspector.has_table("cms_subscribers"):
        ...
        op.drop_index("ix_cms_subscribers_email", table_name="cms_subscribers")
