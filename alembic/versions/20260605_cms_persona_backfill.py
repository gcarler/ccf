"""Backfill CMS author persona UUID columns

Revision ID: 20260605_cms_persona_backfill
Revises: 20260605_crm_persona_backfill
...
revision: str = "20260605_cms_persona_backfill"
...
CMS_BACKFILLS = (
    ...
    ("cms_themes", "created_by_persona_id", "created_by"),
    ("cms_themes", "updated_by_persona_id", "updated_by"),
    ("cms_pages", "created_by_persona_id", "created_by"),
    ("cms_pages", "updated_by_persona_id", "updated_by"),
    ("cms_page_versions", "created_by_persona_id", "created_by"),
    ("cms_sections", "created_by_persona_id", "created_by"),
    ("cms_sections", "updated_by_persona_id", "updated_by"),
...
def downgrade() -> None:
    bind = op.get_bind()
    if bind.dialect.name == "postgresql":
        for table, target_col, _source_col in reversed(CMS_BACKFILLS):
            bind.execute(
                sa.text(
