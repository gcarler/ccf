...
def upgrade() -> None:
    ...
    op.add_column(
        "personas",
        sa.Column(
            "origen_sesion_id", sa.Integer(), sa.ForeignKey("sesiones_grupo.id", ondelete="SET NULL"), nullable=True
        ),
    )
    ...
    op.add_column(
        "crm_casos",
        sa.Column(
            "origen_grupo_id", sa.UUID(), sa.ForeignKey("grupos_evangelismo.id", ondelete="SET NULL"), nullable=True
        ),
    )
    op.add_column(
        "crm_casos",
