...
def upgrade() -> None:
    ...
    op.execute(
        "DELETE FROM project_comments WHERE task_id IS NOT NULL AND task_id NOT IN (SELECT id FROM project_tasks)"
    )
    ...
    op.create_foreign_key(
        "project_documents_project_id_fkey", "project_documents", "projects", ["project_id"], ["id"], ondelete="CASCADE"
    )

    op.execute("ALTER TABLE project_attachments DROP CONSTRAINT IF EXISTS project_attachments_task_id_fkey")
    op.create_foreign_key(
        "project_attachments_task_id_fkey",
        "project_attachments",
        "project_tasks",
        ["task_id"],
        ["id"],
    ...
    op.execute("ALTER TABLE task_supplies DROP CONSTRAINT IF EXISTS task_supplies_task_id_fkey")
    op.create_foreign_key(
        "task_supplies_task_id_fkey", "task_supplies", "project_tasks", ["task_id"], ["id"], ondelete="CASCADE"
    )

    op.execute("ALTER TABLE project_comments DROP CONSTRAINT IF EXISTS project_comments_project_id_fkey")
    op.create_foreign_key(
        "project_comments_project_id_fkey", "project_comments", "projects", ["project_id"], ["id"], ondelete="CASCADE"
    )

    op.execute("ALTER TABLE project_comments DROP CONSTRAINT IF EXISTS project_comments_task_id_fkey")
    op.create_foreign_key(
        "project_comments_task_id_fkey", "project_comments", "project_tasks", ["task_id"], ["id"], ondelete="SET NULL"
    )

    op.execute("ALTER TABLE project_phases DROP CONSTRAINT IF EXISTS project_phases_project_id_fkey")
    op.create_foreign_key(
        "project_phases_project_id_fkey", "project_phases", "projects", ["project_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE project_documents DROP CONSTRAINT IF EXISTS project_documents_project_id_fkey")
    op.create_foreign_key(
        "project_documents_project_id_fkey", "project_documents", "_compat_projects", ["project_id"], ["id"]
    )

    op.execute("ALTER TABLE project_attachments DROP CONSTRAINT IF EXISTS project_attachments_task_id_fkey")
    op.create_foreign_key(
        "project_attachments_task_id_fkey", "project_attachments", "_compat_project_tasks", ["task_id"], ["id"]
    )
    ...
    op.execute("ALTER TABLE project_comments DROP CONSTRAINT IF EXISTS project_comments_project_id_fkey")
    op.create_foreign_key(
        "project_comments_project_id_fkey", "project_comments", "_compat_projects", ["project_id"], ["id"]
    )

    op.execute("ALTER TABLE project_comments DROP CONSTRAINT IF EXISTS project_comments_task_id_fkey")
    op.create_foreign_key(
        "project_comments_task_id_fkey", "project_comments", "_compat_project_tasks", ["task_id"], ["id"]
    )

    op.execute("ALTER TABLE project_phases DROP CONSTRAINT IF EXISTS project_phases_project_id_fkey")
    op.create_foreign_key(
        "project_phases_project_id_fkey", "project_phases", "_compat_projects", ["project_id"], ["id"]
    )

    op.execute("ALTER TABLE project_inbox_state DROP CONSTRAINT IF EXISTS project_inbox_state_user_id_fkey")
    op.create_foreign_key(
        "project_inbox_state_user_id_fkey",
        "project_inbox_state",
        "_compat_users",
        ["user_id"],
        ["id"],
