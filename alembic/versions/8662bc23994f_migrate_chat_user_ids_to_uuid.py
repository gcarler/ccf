...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "conversations_last_sender_id_fkey", "conversations", "auth_users", ["last_sender_id"], ["id"]
    )
    op.create_foreign_key(
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "conversations_last_sender_id_fkey", "conversations", "_compat_users", ["last_sender_id"], ["id"]
    )
    op.create_foreign_key(
        "conversation_participants_user_id_fkey",
        "conversation_participants",
