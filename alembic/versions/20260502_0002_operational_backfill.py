...
def upgrade() -> None:
    ...
    if not inspector.has_table("automation_rules"):
        ...
        op.create_index(
            op.f("ix_automation_rules_id"), "automation_rules", ["id"], unique=False
        )
        op.create_index(
            op.f("ix_automation_rules_trigger_type"),
            "automation_rules",
            ["trigger_type"],
            unique=False,
        )
        op.create_index(
            op.f("ix_automation_rules_is_active"),
            "automation_rules",
            ["is_active"],
            unique=False,
        )
    ...
    if not inspector.has_table("project_documents"):
        ...
        op.create_index(
            op.f("ix_project_documents_id"), "project_documents", ["id"], unique=False
        )
        op.create_index(
        ...
        op.create_index(
            op.f("ix_project_documents_created_at"),
            "project_documents",
            ["created_at"],
            unique=False,
        )
    ...
    if not inspector.has_table("project_whiteboards"):
        ...
        op.create_index(
            op.f("ix_project_whiteboards_id"),
            "project_whiteboards",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_project_whiteboards_project_id"),
            "project_whiteboards",
            ["project_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_project_whiteboards_created_at"),
            "project_whiteboards",
            ["created_at"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    if inspector.has_table("project_whiteboards"):
        op.drop_index(
            op.f("ix_project_whiteboards_created_at"), table_name="project_whiteboards"
        )
        op.drop_index(
            op.f("ix_project_whiteboards_project_id"), table_name="project_whiteboards"
        )
        op.drop_index(
            op.f("ix_project_whiteboards_id"), table_name="project_whiteboards"
        )
        op.drop_table("project_whiteboards")

    if inspector.has_table("project_documents"):
        op.drop_index(
            op.f("ix_project_documents_created_at"), table_name="project_documents"
        )
        op.drop_index(
    ...
    if inspector.has_table("automation_rules"):
        op.drop_index(
            op.f("ix_automation_rules_is_active"), table_name="automation_rules"
        )
        op.drop_index(
            op.f("ix_automation_rules_trigger_type"), table_name="automation_rules"
        )
