...
def upgrade() -> None:
    ...
    if not _has_table(inspector, "member_positions"):
        op.create_table(
            ...
            sa.UniqueConstraint("member_id", "position_id", "start_date", name="uq_member_position_history"),
        )
        op.create_index("ix_member_positions_member_id", "member_positions", ["member_id"], unique=False)
        op.create_index("ix_member_positions_position_id", "member_positions", ["position_id"], unique=False)
        op.create_index("ix_member_positions_start_date", "member_positions", ["start_date"], unique=False)
        op.create_index("ix_member_positions_end_date", "member_positions", ["end_date"], unique=False)
        op.create_index("ix_member_positions_is_active", "member_positions", ["is_active"], unique=False)
        op.create_index("ix_member_positions_created_at", "member_positions", ["created_at"], unique=False)
    ...
    if not _has_table(inspector, "event_attendances"):
        op.create_table(
            ...
            sa.Column("member_id", sa.Integer(), nullable=False),
            sa.Column("status", sa.String(length=30), nullable=False, server_default=sa.text("'present'")),
            sa.Column("role_at_event", sa.String(length=30), nullable=False, server_default=sa.text("'attendee'")),
        ...
        op.create_index("ix_event_attendances_event_id", "event_attendances", ["event_id"], unique=False)
        op.create_index("ix_event_attendances_session_date", "event_attendances", ["session_date"], unique=False)
        op.create_index("ix_event_attendances_member_id", "event_attendances", ["member_id"], unique=False)
        op.create_index("ix_event_attendances_status", "event_attendances", ["status"], unique=False)
        op.create_index("ix_event_attendances_role_at_event", "event_attendances", ["role_at_event"], unique=False)
        op.create_index("ix_event_attendances_source", "event_attendances", ["source"], unique=False)
        op.create_index("ix_event_attendances_check_in_at", "event_attendances", ["check_in_at"], unique=False)
        op.create_index("ix_event_attendances_check_out_at", "event_attendances", ["check_out_at"], unique=False)
        op.create_index("ix_event_attendances_scanned_at", "event_attendances", ["scanned_at"], unique=False)
        op.create_index("ix_event_attendances_attended", "event_attendances", ["attended"], unique=False)
    ...
    if not _has_table(inspector, "consolidation_cases"):
        op.create_table(
            ...
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("member_id", sa.Integer(), nullable=False),
            sa.Column("stage", sa.String(length=20), nullable=False, server_default=sa.text("'new'")),
        ...
        op.create_index("ix_consolidation_cases_member_id", "consolidation_cases", ["member_id"], unique=False)
        op.create_index("ix_consolidation_cases_stage", "consolidation_cases", ["stage"], unique=False)
        op.create_index("ix_consolidation_cases_status", "consolidation_cases", ["status"], unique=False)
        op.create_index("ix_consolidation_cases_source", "consolidation_cases", ["source"], unique=False)
        op.create_index("ix_consolidation_cases_last_contact_at", "consolidation_cases", ["last_contact_at"], unique=False)
        op.create_index("ix_consolidation_cases_next_contact_at", "consolidation_cases", ["next_contact_at"], unique=False)
        op.create_index("ix_consolidation_cases_assigned_pastor_id", "consolidation_cases", ["assigned_pastor_id"], unique=False)
        op.create_index("ix_consolidation_cases_assigned_leader_id", "consolidation_cases", ["assigned_leader_id"], unique=False)
        op.create_index("ix_consolidation_cases_created_at", "consolidation_cases", ["created_at"], unique=False)
        op.create_index("ix_consolidation_cases_updated_at", "consolidation_cases", ["updated_at"], unique=False)
    ...
    if not _has_table(inspector, "consolidation_assignments"):
        ...
        op.create_index("ix_consolidation_assignments_case_id", "consolidation_assignments", ["case_id"], unique=False)
        op.create_index(
        ...
        op.create_index("ix_consolidation_assignments_priority", "consolidation_assignments", ["priority"], unique=False)
        op.create_index("ix_consolidation_assignments_start_date", "consolidation_assignments", ["start_date"], unique=False)
        op.create_index("ix_consolidation_assignments_end_date", "consolidation_assignments", ["end_date"], unique=False)
        op.create_index("ix_consolidation_assignments_status", "consolidation_assignments", ["status"], unique=False)
        op.create_index("ix_consolidation_assignments_created_at", "consolidation_assignments", ["created_at"], unique=False)
    ...
    if not _has_table(inspector, "consolidation_interactions"):
        ...
        op.create_index("ix_consolidation_interactions_case_id", "consolidation_interactions", ["case_id"], unique=False)
        op.create_index(
        ...
        op.create_index("ix_consolidation_interactions_created_at", "consolidation_interactions", ["created_at"], unique=False)
    ...
    if not _has_table(inspector, "consolidation_follow_up_tasks"):
        ...
        op.create_index("ix_consolidation_follow_up_tasks_due_date", "consolidation_follow_up_tasks", ["due_date"], unique=False)
        op.create_index("ix_consolidation_follow_up_tasks_status", "consolidation_follow_up_tasks", ["status"], unique=False)
        op.create_index(
        ...
        op.create_index("ix_consolidation_follow_up_tasks_created_at", "consolidation_follow_up_tasks", ["created_at"], unique=False)
...
def downgrade() -> None:
    ...
    if _has_table(inspector, "consolidation_follow_up_tasks"):
        op.drop_index("ix_consolidation_follow_up_tasks_created_at", table_name="consolidation_follow_up_tasks")
        op.drop_index("ix_consolidation_follow_up_tasks_completed_at", table_name="consolidation_follow_up_tasks")
        op.drop_index("ix_consolidation_follow_up_tasks_status", table_name="consolidation_follow_up_tasks")
        op.drop_index("ix_consolidation_follow_up_tasks_due_date", table_name="consolidation_follow_up_tasks")
        op.drop_index("ix_consolidation_follow_up_tasks_assignment_id", table_name="consolidation_follow_up_tasks")
        op.drop_index("ix_consolidation_follow_up_tasks_case_id", table_name="consolidation_follow_up_tasks")
        op.drop_table("consolidation_follow_up_tasks")

    if _has_table(inspector, "consolidation_interactions"):
        op.drop_index("ix_consolidation_interactions_created_at", table_name="consolidation_interactions")
        op.drop_index("ix_consolidation_interactions_next_action_date", table_name="consolidation_interactions")
        op.drop_index("ix_consolidation_interactions_interaction_date", table_name="consolidation_interactions")
        op.drop_index("ix_consolidation_interactions_interaction_type", table_name="consolidation_interactions")
        op.drop_index(
            "ix_consolidation_interactions_performed_by_member_id",
            table_name="consolidation_interactions",
        )
        op.drop_index("ix_consolidation_interactions_case_id", table_name="consolidation_interactions")
        op.drop_table("consolidation_interactions")

    if _has_table(inspector, "consolidation_assignments"):
        op.drop_index("ix_consolidation_assignments_created_at", table_name="consolidation_assignments")
        op.drop_index("ix_consolidation_assignments_status", table_name="consolidation_assignments")
        op.drop_index("ix_consolidation_assignments_end_date", table_name="consolidation_assignments")
        op.drop_index("ix_consolidation_assignments_start_date", table_name="consolidation_assignments")
        op.drop_index("ix_consolidation_assignments_priority", table_name="consolidation_assignments")
        op.drop_index(
            "ix_consolidation_assignments_assigned_to_member_id",
        ...
        op.drop_index("ix_consolidation_assignments_case_id", table_name="consolidation_assignments")
    ...
    if _has_table(inspector, "consolidation_cases"):
        ...
        op.drop_index("ix_consolidation_cases_assigned_leader_id", table_name="consolidation_cases")
        op.drop_index("ix_consolidation_cases_assigned_pastor_id", table_name="consolidation_cases")
