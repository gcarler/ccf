...
**DEPLOY-ALERT (prod ops):** dos migraciones penden `alembic upgrade head` en prod — `20260725_0002_communication_logs_deleted_at.py` (QC-02) + `20260725_0003_support_tickets_event_attendances_deleted_at.py` (QC-06 + QC-07). Ambas en `alembic/canonical_versions/`, idempotentes (helpers `_has_column`), SQLite no-op early-return. Ejecutar antes del próximo deploy de runtime CRM si se tocaran endpoints de messaging/support/events en prod.
