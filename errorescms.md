...
| M-05 | ✅ CERRADO | `CmsPageVersion.created_at` ahora tiene `index=True` (migración `20260723_0004` añade `ix_cms_page_versions_created_at`). Las queries de list_versions ordenan por `version_number DESC`, pero las queries de búsqueda de versiones recientes se benefician del índice en `created_at` para tablas con muchas versiones. | (pending commit) |
...
- Medios: 5/14 cerrados (M-01, M-02, M-03, M-05, M-13)
- Info: 0/17 cerrados
- Pendientes: M-04/M-06..M-12/M-14 (9), I-01..I-17 (17), F-03..F-05/F-07/F-08/F-10 (6) = 32 findings
