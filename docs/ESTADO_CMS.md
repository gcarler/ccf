...
35. **Cierre builder residual** `[DONE-BUILDER-CMS-002]` — cerrado el 2026-08-01; el `PEND-CMS-BUILDER-001` queda cerrado con las suites E2E mockeadas del builder (`builder-flow.spec.ts` 6, `builder-puck-flow.spec.ts` 3, `pages-preview.spec.ts` 3) pasando sin regresiones de tests.
