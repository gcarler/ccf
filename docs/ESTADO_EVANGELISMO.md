...
- Backend evangelismo directo (incl. models/crud/schemas): **~12 560 LOC** (verificado 2026-08-23)
- Frontend evangelismo directo (app + componentes): **~16 690 LOC** (verificado 2026-08-23)
