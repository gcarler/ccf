...
def cms_pastoral_profile_update(
    ...
    return schemas.PastoralProfileRead(
        id=str(persona.id), name=name, slug=_slugify(name), photo_url=persona.photo_url,
        bio_short=persona.bio_short, bio_full=persona.bio_full, role=_pastoral_role(persona),
        social_instagram=persona.social_instagram, social_facebook=persona.social_facebook,
        social_twitter=persona.social_twitter, is_main_pastor=persona.is_main_pastor or False,
