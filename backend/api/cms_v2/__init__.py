...
# Fase 4 refactor: global blocks CRUD extracted to ``global_blocks.py``.
...
# Fase 4 refactor: sites CRUD extracted to ``sites.py``.
...
# ``_assert_role`` now live in ``_shared`` (imported at top of file).

# Fase 4 refactor: sites CRUD extracted to ``sites.py`` (sub-router mounted
# via ``router.include_router`` below).
...
# Fase 4 refactor: global blocks CRUD extracted to ``global_blocks.py``.
# The sub-router is mounted below via ``router.include_router``.
