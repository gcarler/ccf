...
def seed_agent_data():
    ...
    tasks = [
        (
            "Optimizar Retenci??n Academia",
            "Se detect?? una ca??da del 15% en la finalizaci??n del M??dulo 2. Sugerido: Campa??a de recordatorio v??a WhatsApp.",
            "pending",
            "Intelligence Engine",
            "Pastoral Care",
            "high",
        ...
        (
            "Auditor??a de Ofrendas",
            "Desviaci??n inusual detectada en la zona norte. Verificar registros manuales vs digitales.",
            "pending",
            "Financial Agent",
            "Admin Finance",
            "medium",
        ...
        (
            ...
            "5 nuevos leads en etapa 'new' sin contacto por > 24h.",
            "pending",
            "CRM Agent",
            "Liderazgo Local",
            "high",
    ...
    insights = [
        (
            ...
            "Growth",
            json.dumps({"metric": "Miembros", "increase": "22%", "period": "Feb-Mar"}),
            0,
        ),
        (
            "Alerta de Deserci??n",
            ...
            json.dumps(
                {
                    "impact": "M??dulo 2 Academia",
                    "risk": "High",
                    "recommendation": "Webinar de refuerzo",
                }
            ),
            0,
        ),
        (
            ...
            json.dumps(
                {
                    "saving": "$450/mo",
                    "insight": "Automatizaci??n de comprobantes completada",
                }
            ),
            0,
        ),
