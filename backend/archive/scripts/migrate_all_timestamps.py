...
for table in tables:
    ...
    try:
        ...
        if "created_at" not in columns:
            ...
            cursor.execute(
                "ALTER TABLE \"{}\" ADD COLUMN created_at DATETIME DEFAULT '2026-03-01 00:00:00'".format(
                    table
                )
            )
        ...
        if "updated_at" not in columns:
            ...
            cursor.execute(
                "ALTER TABLE \"{}\" ADD COLUMN updated_at DATETIME DEFAULT '2026-03-01 00:00:00'".format(
                    table
                )
            )
