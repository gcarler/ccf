...
def seed_final_content():
    ...
    page_contents = [
        ...
        ('support_page', json.dumps({
            ...
            "categories": [
                {"title": "Soporte T??cnico", "desc": "Dudas sobre acceso y contrase??as.", "type": "tech"},
                {"title": "Academia", "desc": "Preguntas sobre certificados y cursos.", "type": "academic"},
                {"title": "Pastoral", "desc": "L??neas de atenci??n espiritual.", "type": "pastoral"}
            ]
        })),
        # Donation Categories
            ...
            "steps": [
                {
                    ...
                    "features": [
                        {"title": "Crecimiento", "desc": "Fortalece tu esp??ritu con recursos y lecciones b??blicas.", "icon": "BookOpen"},
                        {"title": "Comunidad", "desc": "Conecta con grupos de vida y eventos locales.", "icon": "Users"},
                        {"title": "Prop??sito", "desc": "Encuentra y sirve seg??n el plan de Dios para ti.", "icon": "Heart"}
                    ]
                }
            ]
        })),
    ...
    events = [
        ...
        ("Estudio B??blico: Fundamentos", "M??dulo intensivo sobre las bases de la fe cristiana para nuevos l??deres.", "Academia", (now + dt.timedelta(days=7)).isoformat())
    ]
    cursor.executemany("""
