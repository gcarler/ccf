...
BLOCK_TYPES = {
    ...
    "text": {
        ...
        "icon": "AlignLeft",
        "category": "content",
        "default_props": {"content": "<p>Escribe tu mensaje aqui...</p>", "textAlign": "left"},
    },
    "button": {
        "label": "Boton CTA",
    ...
    "image": {
        ...
        "icon": "Image",
        "category": "content",
        "default_props": {"src": "", "alt": "", "width": "100%", "href": ""},
    },
    "divider": {
        "label": "Divisor",
        "icon": "Minus",
        "category": "layout",
        "default_props": {"color": "#e5e7eb", "thickness": 1, "style": "solid", "width": "100%"},
    },
    ...
    "verse": {
        ...
        "icon": "BookOpen",
        "category": "content",
        "default_props": {"text": "Jeremias 29:11", "reference": "Jeremias 29:11", "textAlign": "center"},
    },
    "columns": {
        "label": "Columnas",
        "icon": "Columns",
        "category": "layout",
        "default_props": {"count": 2, "columns": [{"blocks": []}, {"blocks": []}]},
    },
}
