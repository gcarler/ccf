...
def render_event_invitation(vars: Dict[str, str], brand: Optional[Dict[str, str]] = None) -> str:
    ...
    if fecha:
        details += (
            f'<p style="margin:0 0 6px 0;"><strong style="color:{b["dark"]};">&#128197; Fecha:</strong> {fecha}</p>'
        )
    if hora:
        details += (
            f'<p style="margin:0 0 6px 0;"><strong style="color:{b["dark"]};">&#128336; Hora:</strong> {hora}</p>'
        )
    if lugar:
        details += (
            f'<p style="margin:0 0 6px 0;"><strong style="color:{b["dark"]};">&#128205; Lugar:</strong> {lugar}</p>'
        )
