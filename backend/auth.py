...
from backend.core.permissions import (  # noqa: F401
    ...
    hash_password, is_crm_privileged, normalize_role, oauth2_scheme,
    record_session, require_active_user, require_admin,
    require_coordinator_or_admin, require_pastor_or_admin, require_permission,
    require_staff_or_admin, require_teacher_or_admin, role_in)
