...
def get_donations(db: Session, skip: int = 0, limit: int = 100, sede_id: UUID | None = None) -> List[models.Donation]:
...
def get_total_donations_amount(db: Session, sede_id: UUID | None = None) -> float:
