...
from backend.crud.crm import (create_community_card,
                              ...
                              create_cell_group, create_persona,
                              ...
                              delete_cell_group, delete_persona,
                              delete_milestone, delete_prayer_request,
                              delete_support_ticket, delete_volunteer_shift,
                              delete_ministry, delete_position,
                              get_community_board, get_community_cards,
                              ...
                              get_cell_groups, get_persona,
                              get_persona, get_persona_donations, get_persona_timeline,
                              get_personas, get_user_sede_id, get_milestones,
                              ...
                              update_milestone, update_persona, update_prayer_request, update_support_ticket,
                              update_volunteer_shift)
# CRM Extended — roles, positions, ministries, funds, skills, automations, chat
from backend.crud.crm_extended import (  # noqa: F401; Positions; Persona Positions; Event Assignments; Ministries; Persona Ministries; CRM Automations; Role Definitions; Persona Roles; Funds; Volunteer Skills; Chat Messages; Conversations
    ...
    create_crm_automation, create_conversation, create_direct_message,
    create_event_assignment, create_fund,
    ...
    get_chat_message, get_chat_messages, get_conversation,
    get_conversation_messages, get_crm_automation,
    ...
    get_unread_count_for_conversation, get_user_conversations,
    get_volunteer_skill, get_volunteer_skills, mark_conversation_read,
