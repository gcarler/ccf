...
from backend.crud.crm import (create_community_card, create_consolidation_case,
                              ...
                              create_cell_group, create_member,
                              create_milestone, create_pastoral_call_log,
                              create_persona, create_pipeline_lead, create_prayer_request,
                              ...
                              delete_cell_group, delete_member,
                              delete_milestone, delete_pastoral_call_log,
                              delete_persona, delete_pipeline_lead, delete_prayer_request,
                              ...
                              update_cell_group, update_member,
                              update_milestone, update_pipeline_lead,
                              update_persona, update_prayer_request, update_support_ticket,
